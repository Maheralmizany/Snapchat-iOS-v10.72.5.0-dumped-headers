...
#import "SCSimpleFriendSelectorDelegate.h"
...
- (void).cxx_destruct;
- (void)_presentRetryCancelDialogWithMessage:(id)arg1 retryBlock:(CDUnknownBlockType)arg2 cancelBlock:(CDUnknownBlockType)arg3;
...
- (void)_updateHomeFilterEnabled:(_Bool)arg1;
