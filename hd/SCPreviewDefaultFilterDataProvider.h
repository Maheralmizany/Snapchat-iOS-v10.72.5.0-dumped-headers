...
- (void)clear;
- (id)initWithSnapSource:(long long)arg1 unlockableDataStore:(id)arg2 streakCount:(long long)arg3 userSession:(id)arg4 fullScreenImageFuture:(id)arg5 mediaOrientation:(long long)arg6 filterContextData:(id)arg7 selectedCommandConfiguration:(id)arg8;
