...
#import "SCLegacyUserLifecycle.h"
...
@interface SCAppDelegate : UIResponder <SCTraceEnabled, SCInAppNotificationInteractionDelegate, SCLegacyUserLifecycle, UIApplicationDelegate, UNUserNotificationCenterDelegate, PKPushRegistryDelegate, SCCrashLoggerDelegate>
{
...
- (_Bool)_canHandleShortcutItemType:(id)arg1;
