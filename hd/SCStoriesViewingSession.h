...
- (id)initWithUserSession:(id)arg1 user:(id)arg2 startChatDelegate:(id)arg3 storiesPlaybackDataProvider:(id)arg4 storiesMediaCoordinator:(id)arg5 storyUserProperties:(id)arg6 storyPlayMode:(long long)arg7 viewLocation:(long long)arg8 viewingType:(long long)arg9 storyViewingActionContext:(unsigned long long)arg10 playSource:(long long)arg11 navigationDelegate:(id)arg12 storiesBlizzardLogger:(id)arg13 unlockableBlizzardLogger:(id)arg14 loggingInfo:(id)arg15;
