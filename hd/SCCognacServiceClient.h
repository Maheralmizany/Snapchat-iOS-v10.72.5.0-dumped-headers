...
#import "SCCognacAppInstanceAuthTokenProviding.h"
#import "SCSearchV2CognacTokenProviding.h"
...
- (void)launchAppInstanceWithAppId:(id)arg1 conversationId:(id)arg2 sharedId:(id)arg3 completionQueue:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;
