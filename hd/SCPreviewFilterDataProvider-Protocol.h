...
#import "SCPreviewFilterVisualNamesProvider.h"
#import "SCPreviewInfoStickerDataSource.h"

@class NSArray, NSDictionary, NSString, SCAltitudeFilterView, SCCarouselGroupConfigParser, SCGeoFilter, SCImageProcessCommandConfiguration, SCPreviewFilterDataProviderContextData, SCSnapCommonLoggingParameters, SCUnlockablesContextBasedSelector, SCVenueFilterSelector, SCWeatherFilterView;
...
@property(readonly, copy, nonatomic) SCImageProcessCommandConfiguration *selectedCommandConfiguration;
...
- (SCGeoFilter *)geofilterByFilterId:(NSString *)arg1;
