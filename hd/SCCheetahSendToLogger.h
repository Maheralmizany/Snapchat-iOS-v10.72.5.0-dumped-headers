...
@interface SCCheetahSendToLogger : NSObject <SCEventListener>
{
    ...
    _Bool _listsHaveBeenViewed;
    unsigned long long _listsAvailable;
...
- (void)_updateFriendsSelectedForBatchSelection:(id)arg1;
...
- (void)_updateListsAvailableCount;
...
- (id)initWithRecipientDataSource:(id)arg1 storiesDataSource:(id)arg2 coRecipientDataProvider:(id)arg3 listsDataFetcher:(id)arg4 sessionId:(id)arg5 configuration:(id)arg6;
