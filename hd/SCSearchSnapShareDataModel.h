...
@interface SCSearchSnapShareDataModel : NSObject <NSCopying>
{
...
- (id)initWithDynamicStoryId:(id)arg1 mediaType:(long long)arg2 snapId:(id)arg3 additionalText:(id)arg4;
