...
@property(nonatomic) _Bool hasNumStoryStoryViewViaTapPos0; // @dynamic hasNumStoryStoryViewViaTapPos0;
@property(nonatomic) _Bool hasNumStoryStoryViewViaTapPos1To3; // @dynamic hasNumStoryStoryViewViaTapPos1To3;
@property(nonatomic) _Bool hasNumStoryStoryViewViaTapPos4To10; // @dynamic hasNumStoryStoryViewViaTapPos4To10;
@property(nonatomic) _Bool hasNumStoryStoryViewViaTapPosBeyond11; // @dynamic hasNumStoryStoryViewViaTapPosBeyond11;
...
@property(retain, nonatomic) WindowedIntMetrics *numStoryStoryViewViaTapPos0; // @dynamic numStoryStoryViewViaTapPos0;
@property(retain, nonatomic) WindowedIntMetrics *numStoryStoryViewViaTapPos1To3; // @dynamic numStoryStoryViewViaTapPos1To3;
@property(retain, nonatomic) WindowedIntMetrics *numStoryStoryViewViaTapPos4To10; // @dynamic numStoryStoryViewViaTapPos4To10;
@property(retain, nonatomic) WindowedIntMetrics *numStoryStoryViewViaTapPosBeyond11; // @dynamic numStoryStoryViewViaTapPosBeyond11;
