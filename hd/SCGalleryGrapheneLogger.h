...
+ (void)fireGalleryOperationTotalTimeMetricWithQueueLength:(long long)arg1 duration:(double)arg2 operationType:(id)arg3;
...
+ (void)fireGalleryExpiredUserDataPurged;
+ (void)fireGalleryUserDataStatus:(_Bool)arg1 hasLogoutUserData:(_Bool)arg2;
+ (void)fireGalleryDataObjectError:(id)arg1;
