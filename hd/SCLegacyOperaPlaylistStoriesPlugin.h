...
@class NSString, SCDiscoverFeedMiniProfileHandler, SCLegacyOperaStoriesPageProviderPlaylistAdapter, SCLegacyStoriesOperaDataSource, SCLegacyStoriesViewingSession, SCObservable, SCOperaViewController, SCSearchDynamicStoryActionHandler, SCUserSession;
