...
#import "SCChatMessageActionHandling.h"
#import "SCChatUIActionHandling.h"

@class SCArroyoMediaFetcher, SCBoltUploadManager, SCChatMediaRequestManager, SCChatMediaStateManager, SCChatSendBlockAssigner, SCChatV3MetadataStore, SCLazy, SCLegacyPresenceMessageSender, SCNMessagingUUID, SCQueuePerformer, SCSnapStateMetadataManager;
...
@interface SCArroyoMessageActionHandler : NSObject <SCChatMessageActionHandling, SCChatUIActionHandling>
{
    ...
    SCLegacyPresenceMessageSender *_legacyPresenceMessageSender;
}
...
- (void)_conversationId:(id)arg1 openSnap:(id)arg2 stackId:(id)arg3 isFirstSnapInStack:(_Bool)arg4 atTime:(id)arg5;
...
- (void)conversationId:(id)arg1 finishViewingSnap:(id)arg2 enforceMessageExists:(_Bool)arg3 cellViewPosition:(long long)arg4;
...
- (void)conversationId:(id)arg1 finishViewingSnap:(id)arg2 cellViewPosition:(long long)arg3;
...
- (id)initWithNativeSessionManager:(id)arg1 nativeSnapManager:(id)arg2 mediaFetcher:(id)arg3 metadataStore:(id)arg4 blockAssigner:(id)arg5 userId:(id)arg6 uploadManager:(id)arg7 coreMessageSender:(id)arg8 textMessageSender:(id)arg9 mediaStateManager:(id)arg10 mediaRequestManager:(id)arg11 conversationDataCoordinator:(id)arg12 legacyPresenceMessageSender:(id)arg13;
