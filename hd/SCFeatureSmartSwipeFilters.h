...
#import "SCFeatureSwipeFilters.h"
#import "SCPreviewGestureResponder.h"

@class NSData, NSString, SCFeature<SCFeatureSwipeFilters>, SCLazy, SCObservable, SCPreviewConfiguration, SCPreviewView, SCSmartCarouselFilterArranger, SCSmartSwipeFilterView, SCSnapCommonLoggingParameters, SCUnlockableGeoFilterTracker, SCUserSession, UIView, UIView<SCSmartSwipeFilterFocusLocationChangeDelegate>;
...
@property(nonatomic) __weak id <SCFeatureUcoInMemoriesPreview> ucoInMemoriesFeature; // @synthesize ucoInMemoriesFeature=_ucoInMemoriesFeature;
