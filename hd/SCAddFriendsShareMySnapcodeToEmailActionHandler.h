...
@interface SCAddFriendsShareMySnapcodeToEmailActionHandler : NSObject <MFMailComposeViewControllerDelegate, SCAddFriendsPageEventObservableRepository, SCActionHandling>
{
