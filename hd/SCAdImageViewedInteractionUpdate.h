...
@interface SCAdImageViewedInteractionUpdate : NSObject <NSCopying>
{
...
- (id)initWithAdIdentifier:(id)arg1 snapIndex:(long long)arg2 mediaDurationInMillis:(long long)arg3 viewedDurationInMillis:(long long)arg4;
