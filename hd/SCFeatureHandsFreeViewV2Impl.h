...
#import "SCFeatureHandsFreeView.h"

@class NSString, SCFeatureHandsFreeTooltip, SCGradientView, SCGrowingButton, SCUserSession, SCVideoCaptureConfiguration, UIImageView, UIView<SCFeatureContainerView>;
