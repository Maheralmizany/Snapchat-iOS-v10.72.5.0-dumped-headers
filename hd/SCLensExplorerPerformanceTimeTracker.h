...
#import "SCLensExplorerPerformanceTimeTracking.h"
...
@interface SCLensExplorerPerformanceTimeTracker : NSObject <SCLensExplorerPerformanceTimeTracking>
{
    ...
    NSMutableDictionary *_lensExplorerPageAppearenceTypeToTimeMap;
...
- (double)lensExplorerPageAppearenceTimeWithEntryPoint:(id)arg1;
...
- (void)trackLensExplorerPageAppearenceTimeWithEntryPoint:(id)arg1;
