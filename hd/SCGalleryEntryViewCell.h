...
#import "SCGalleryViewCellScreenPosition.h"
#import "SCProgressReceiving.h"

@class CAShapeLayer, NSArray, NSDictionary, NSString, NSTimer, SCGalleryDebugSyncStatusChecker, SCGalleryDebugSyncStatusView, SCGalleryEntrySyncStatusGenerator, SCGalleryEntryThumbnailGenerator, SCLoadingIndicatorView, SCMemoriesStatusIcon, SCSentinel, SCUserSession, UIImage, UIImageView, UILabel, UIView;
