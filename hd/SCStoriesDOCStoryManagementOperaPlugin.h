...
#import "SCStoryManagementActionHandlerDelegate.h"

@class NSString, SCDisposableObserverLifecycle, SCOperaViewController, SCStoryManagementActionHandler, SCUserSession;
...
@interface SCStoriesDOCStoryManagementOperaPlugin : SCOperaPlaylistEventTrackerPlugin <SCOperaPlaylistItemExtraPropertiesProvider, SCStoryManagementActionHandlerDelegate, SCDataCoordinatorListener>
{
    ...
    NSString *_currentSnapUniqueConsistentId;
...
- (void)_handleFetchedStorySummaryInfo:(id)arg1 actionDataModel:(id)arg2 sourceView:(id)arg3;
- (void)_handleTapAvatarWithSnap:(id)arg1 params:(id)arg2;
- (void)_presentProfileWithSnap:(id)arg1 params:(id)arg2;
- (void)_retryPostWithClientId:(id)arg1 username:(id)arg2;
...
- (id)initWithUserSession:(id)arg1 myStories:(id)arg2 storiesMediaCoordinator:(id)arg3 playbackManagementDataProvider:(id)arg4 operaPageProviderObservable:(id)arg5 isSingleSnap:(_Bool)arg6 shouldShowViewersListOnOpen:(_Bool)arg7 startChatDelegate:(id)arg8 navigationDelegate:(id)arg9;
