...
@class NSString, SCCognacAppViewLifeCycleListenerAnnouncer, SCCognacBlizzardEventLoggingController, SCCognacDataStorage, SCCognacOperaDataSource, SCCognacServiceCoordinator, SCCognacSnapchatterService, SCPreferences, UIViewController;
