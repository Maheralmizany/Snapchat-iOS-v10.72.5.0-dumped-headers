...
@class NSArray, NSError, NSOperationQueue, NSValue, SPAnimatorLoadingFaceNeutralizationOperation, SPAnimatorLoadingGenderDetectionOperation, SPAnimatorLoadingPreprocessingOperation, SPAnimatorLoadingResultCacheOperation, SPAnimatorLoadingResultRestoreOperation, SPAnimatorLoadingSegmentationOperation, SPBeautificationOperation, SPFaceDetectionResult, SPGenderResult, SPImage, SPLandmarksExtractionOperation, SPLandmarksValidationOperation, SPPersonTechAnalytics, SPSharedQueuesHolder, UIImage;
...
- (id)cacheKeyFromImageIdentifier:(id)arg1;
