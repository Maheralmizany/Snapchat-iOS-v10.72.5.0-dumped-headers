...
#import "SCCameraLensesControllerProtocol.h"
#import "SCFeatureLensInfoButtonPositioningDelegate.h"
#import "SCLensEntryPointTrackableProtocol.h"
#import "SCPageNameLogging.h"
#import "SCTraceEnabled.h"
#import "UIGestureRecognizerDelegate.h"

@class NSObject<OS_dispatch_queue>, NSString, SCArcadiaUIController, SCCameraLensesInteractor, SCCameraLensesSnappablesSelectionHandler, SCGrowingButton, SCLensAnalyticsDataManger, SCLensCoreAnalyticsListener, SCLensEntryPointProvider, SCLensEntryPointTracker, SCLensInfoController, SCLensInfoViewModel, SCSnappablesPlayButton, SCUserSession, UIButton, UILongPressGestureRecognizer, UITapGestureRecognizer, UIView;

@interface SCCameraLensesUIController : SCBaseLensesUIController <SCTraceEnabled, UIGestureRecognizerDelegate, SCFeatureLensInfoButtonPositioningDelegate, SCCameraLensesControllerProtocol, SCLensEntryPointTrackableProtocol, SCPageNameLogging>
{
...
- (void).cxx_destruct;
- (id)topElementLayoutAnchorForLensInfoButton:(id)arg1;
- (id)bottomLayoutAnchorForLensInfoButton:(id)arg1;
...
- (id)lensFpsLogger;
- (void)dealloc;
- (id)initWithCameraLensesInteractor:(id)arg1 parentViewContainer:(id)arg2 hidableViewContainer:(id)arg3 cameraViewDelegate:(id)arg4 lensProcessingCore:(id)arg5 scanFromLens:(id)arg6 sceneIntelligence:(id)arg7 snappableSelectionHandler:(id)arg8 userSession:(id)arg9 conversationMetadataProvider:(id)arg10 lensUserInterfaceDelegate:(id)arg11 lensCarousel:(id)arg12 lensEntryPointProvider:(id)arg13 lensUserProvider:(id)arg14 lensInfoButton:(id)arg15;
