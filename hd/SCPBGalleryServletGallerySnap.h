...
@property(nonatomic) _Bool hasSpectaclesSecondaryMetadata; // @dynamic hasSpectaclesSecondaryMetadata;
...
@property(copy, nonatomic) NSString *spectaclesSecondaryMetadataRedirectUri; // @dynamic spectaclesSecondaryMetadataRedirectUri;
@property(copy, nonatomic) NSString *spectaclesSecondaryMetadataURL; // @dynamic spectaclesSecondaryMetadataURL;
