...
#import "SCBitmojiStickerSearch.h"

@class NSString, SCBitmojiStickerPackProvider, SCStickerLearnedSearchBitmojiClassifier;
...
@interface SCBitmojiStickerSearch : NSObject <SCBitmojiStickerSearch>
{
    ...
    SCStickerLearnedSearchBitmojiClassifier *_learnedClassifier;
    unsigned long long _learnedClassifierResultsLimit;
}
...
- (id)initWithDatabase:(id)arg1 packProvider:(id)arg2 contentDelivery:(id)arg3 experimentManager:(id)arg4;
