...
@interface SCAdInsertionLogParam : NSObject <NSCopying>
{
    ...
    long long _insertSourceType;
}

@property(readonly, nonatomic) long long insertSourceType; // @synthesize insertSourceType=_insertSourceType;
...
- (id)initWithAdProductType:(unsigned long long)arg1 isFill:(_Bool)arg2 adId:(id)arg3 adRequestClientId:(id)arg4 isRetryInsertionEnabled:(_Bool)arg5 isPrefetchEnabled:(_Bool)arg6 prefetchResponse:(_Bool)arg7 insertSourceType:(long long)arg8;
