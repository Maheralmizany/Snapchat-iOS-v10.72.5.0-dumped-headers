...
#import "SOJUGalleryServletGallerySnap.h"
...
@interface SOJUGalleryServletGallerySnap : NSObject <SOJUGalleryServletGallerySnap>
{
    ...
    NSString *_spectaclesSecondaryMetadataUrl;
    NSNumber *_hasSpectaclesSecondaryMetadata;
    NSString *_spectaclesSecondaryMetadataRedirectUri;
}

+ (unsigned long long *)fasterCodingKeys;
+ (unsigned long long)fasterCodingVersion;
+ (_Bool)canInitFromProto;
@property(readonly, copy, nonatomic) NSString *spectaclesSecondaryMetadataRedirectUri; // @synthesize spectaclesSecondaryMetadataRedirectUri=_spectaclesSecondaryMetadataRedirectUri;
@property(readonly, copy, nonatomic) NSNumber *hasSpectaclesSecondaryMetadata; // @synthesize hasSpectaclesSecondaryMetadata=_hasSpectaclesSecondaryMetadata;
@property(readonly, copy, nonatomic) NSString *spectaclesSecondaryMetadataUrl; // @synthesize spectaclesSecondaryMetadataUrl=_spectaclesSecondaryMetadataUrl;
...
- (_Bool)hasSpectaclesSecondaryMetadataValue;
