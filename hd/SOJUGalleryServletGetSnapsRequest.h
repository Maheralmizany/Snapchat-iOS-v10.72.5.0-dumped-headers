...
#import "SOJUGalleryServletGetSnapsRequest.h"
...
@property(readonly, copy, nonatomic) NSNumber *spectaclesSecondaryMetadataUrl; // @synthesize spectaclesSecondaryMetadataUrl=_spectaclesSecondaryMetadataUrl;
...
- (_Bool)spectaclesSecondaryMetadataUrlValue;
