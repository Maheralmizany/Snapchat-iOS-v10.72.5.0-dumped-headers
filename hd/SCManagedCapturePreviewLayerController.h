...
#import "SCCameraHealthMonitorDelegate.h"
#import "SCManagedCapturerListener.h"
#import "SCManagedSampleBufferDisplayController.h"

@class AVCaptureVideoPreviewLayer, CAMetalLayer, FBKVOController, NSMutableSet, NSObject<OS_dispatch_semaphore>, NSString, SCCameraHealthMonitor, SCCoreCameraOpenLogger, SCManagedCapturePreviewView, SCQueuePerformer, UIView, UIView<LSAGLView>;
