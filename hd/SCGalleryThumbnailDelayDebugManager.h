...
@class NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, SCGalleryLogger, SCQueuePerformer, SCRefreshableDebugView;
...
- (void)show;
- (id)initWithUserId:(id)arg1 username:(id)arg2 logger:(id)arg3;
