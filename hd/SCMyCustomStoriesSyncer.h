...
- (id)initWithMyStoriesCollection:(id)arg1 groupStoryCollection:(id)arg2 customStoriesDataTracker:(id)arg3 docObjectContext:(id)arg4 storiesUnarchiver:(id)arg5 grapheneMetricsEmitter:(id)arg6 currentUserId:(id)arg7;
