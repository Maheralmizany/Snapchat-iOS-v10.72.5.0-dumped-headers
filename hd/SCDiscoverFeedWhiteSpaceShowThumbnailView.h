...
@class NSString, SCDiscoverFeedBadgeView, SCDiscoverFeedLogoOverlayView, SCDiscoverFeedPublisherStoryProgressBarView, SCGradientView, SCNetworkImageView, UILabel;

@interface SCDiscoverFeedWhiteSpaceShowThumbnailView : UIView <SCViewModelConfigurable, SCDiscoverFeedStoryTileWithCoverImageConfigurable>
{
