...
@property(readonly, nonatomic) int titleOverlayUrlType;
@property(readonly, copy, nonatomic) NSString *titleOverlayUrl;
@property(readonly, copy, nonatomic) NSString *title;
@property(readonly, nonatomic) int thumbnailUrlType;
@property(readonly, copy, nonatomic) NSString *thumbnailUrl;
@property(readonly, nonatomic) _Bool thumbnailEncrypted;
