...
- (void)createNewCheckoutWithStoreId:(id)arg1 contactDetails:(id)arg2 shippingAddress:(id)arg3 partner:(id)arg4 lineItems:(id)arg5 additionalParameters:(id)arg6 traceId:(id)arg7 completionBlock:(CDUnknownBlockType)arg8 failureBlock:(CDUnknownBlockType)arg9;
