...
#import "SCImageProcessLensCommandProcessVideoToTextureAction.h"

#import "SCTraceEnabled.h"

@class NSString;

@interface SCImageProcessLensCommandProcessPortraitVideoToTextureAction : SCImageProcessLensCommandProcessVideoToTextureAction <SCTraceEnabled>
{
}
