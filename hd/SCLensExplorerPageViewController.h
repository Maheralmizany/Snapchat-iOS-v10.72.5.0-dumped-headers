...
#import "SCLensExplorerCategoryViewControllerDelegate.h"
...
@interface SCLensExplorerPageViewController : UIPageViewController <UIPageViewControllerDataSource, UIPageViewControllerDelegate, SCLensExplorerCategoryViewControllerDelegate>
{
    ...
    id <SCLensExplorerCategoriesBatch> _categoriesBatchQueryCoordinator;
...
- (void).cxx_destruct;
- (void)didUpdateContentForViewController:(id)arg1 containItems:(_Bool)arg2 pageViewType:(long long)arg3;
...
- (void)_updateContentForViewController:(id)arg1;
- (void)_setupShadowView;
- (void)_prepareViewControllers;
- (void)_prepareViewControllersForAdditionalCategories;
- (void)_setupLoadingIndicator;
- (void)_observeCategoriesActionHandlerFuture;
- (void)viewDidLoad;
