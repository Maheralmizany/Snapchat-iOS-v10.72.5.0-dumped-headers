...
+ (void)logSnapSaveEvents:(id)arg1 snapIdInSnapchatGallery:(id)arg2 mediaIdInSnapchatGallery:(id)arg3 entryIdInSnapchatGallery:(id)arg4 savingSessionId:(id)arg5 saveToCameraRoll:(_Bool)arg6 manualSave:(_Bool)arg7;
