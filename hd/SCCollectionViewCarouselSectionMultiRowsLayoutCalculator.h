...
@class NSObject<SCCollectionViewCarouselSectionRowCountProviding>, NSString;

@interface SCCollectionViewCarouselSectionMultiRowsLayoutCalculator : NSObject <SCCollectionViewSectionLayoutProviding>
{
    NSObject<SCCollectionViewCarouselSectionRowCountProviding> *_rowCountProvider;
...
- (id)initWithRowCountProvider:(id)arg1;
