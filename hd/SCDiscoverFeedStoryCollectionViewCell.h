...
@class NSString, SCActionModel, SCDiscoverFeedDebugView, SCDiscoverFeedLabelOverlayView, SCEventListenerAnnouncer, SCLazy, SCNetworkImageView, SCRoundedCornerContainerView, SCSearchNetworkVideo, SCSearchNetworkVideoView, UIView;
