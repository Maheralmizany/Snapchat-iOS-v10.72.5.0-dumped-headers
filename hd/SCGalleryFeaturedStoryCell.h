...
@class NSString, SCGalleryEntryThumbnailGenerator, SCGalleryFeaturedStoryCellButton, SCPreviewTooltipBalloon, SCSentinel, SCUserSession, UIButton, UIImageView, UILabel, UIView, YYAnimatedImageView;

@interface SCGalleryFeaturedStoryCell : UICollectionViewCell <SCGalleryEntryThumbnailGeneratorDelegate, SCProgressReceiving, SCGalleryFeaturedStoryCell>
{
