...
@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, SCLazy, SCQueuePerformer, SCSendToListsDataRepository, SCSendToRanker, SCSendToSnappableSnapchattersFetcher, SCSendToThisChatRecipientsFetcher, SCUserSession;
...
- (void)searchFriendsSectionRecipientsWithQuery:(id)arg1 includingMyself:(_Bool)arg2 onlyMutualFriends:(_Bool)arg3 completionQueue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
