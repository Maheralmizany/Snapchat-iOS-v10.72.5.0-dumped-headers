...
- (id)createArroyoBackwardsCompatPresenceMessageForConversationId:(id)arg1 sender:(id)arg2 recipients:(id)arg3 legacyPresences:(id)arg4 extendedPresences:(id)arg5 presencesMetadata:(id)arg6 sequenceNumber:(id)arg7 time:(id)arg8;
