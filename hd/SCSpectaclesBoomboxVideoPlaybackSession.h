...
@class AVAsset, AVPlayer, AVPlayerItem, AVPlayerItemVideoOutput, CADisplayLink, FBKVOController, NSArray, NSObject<OS_dispatch_semaphore>, NSString, SCImageProcessCommand, SCImageProcessPlaybackRenderer, SCImageProcessQueue;
