...
@property(readonly, copy, nonatomic) NSArray *snapAccessTokens;
@property(readonly, copy, nonatomic) NSString *snapSessionRefreshToken;
...
@property(readonly, copy, nonatomic) SOJUSupportToolsSupportToolsResponse *supportToolsResponseDeprecated;
