...
@class SCCropOverlayView, SCCroppingState, SCPreviewConfiguration, SCPreviewToolBarButtonItem, UIView;
...
- (SCCroppingState *)computeCroppingState:(SCCroppingState *)arg1 containerView:(UIView *)arg2 contentScaleFactor:(double)arg3 contentAspectFitSize:(struct CGSize)arg4 useAspectFillByDefault:(_Bool)arg5;
- (SCCroppingState *)createIdentityCroppingState:(struct CGSize)arg1 containerView:(UIView *)arg2 contentScaleFactor:(double)arg3;
- (SCCroppingState *)createInitialCroppingState:(SCPreviewConfiguration *)arg1 containerView:(UIView *)arg2 contentScaleFactor:(double)arg3 contentAspectFitSize:(struct CGSize)arg4;
