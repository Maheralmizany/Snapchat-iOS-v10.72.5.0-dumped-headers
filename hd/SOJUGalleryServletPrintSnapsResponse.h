...
#import "SOJUGalleryServletPrintSnapsResponse.h"

@class NSArray, NSNumber, NSString, SOJUGalleryServletQuota;

@interface SOJUGalleryServletPrintSnapsResponse : NSObject <SOJUGalleryServletPrintSnapsResponse>
{
    ...
    NSString *_requestId;
    NSArray *_printSnapResults;
}

+ (unsigned long long *)fasterCodingKeys;
+ (unsigned long long)fasterCodingVersion;
+ (_Bool)canInitFromProto;
@property(readonly, copy, nonatomic) NSArray *printSnapResults; // @synthesize printSnapResults=_printSnapResults;
