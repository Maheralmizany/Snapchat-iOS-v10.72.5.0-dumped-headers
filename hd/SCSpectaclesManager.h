...
#import "SCCacheClearing.h"
#import "SCSpectaclesContextNotificationTaskHandler.h"
#import "SCSpectaclesDeviceStoreDelegate.h"

@class NSNumber, NSString, SCLazy, SCSpectaclesCache, SCSpectaclesDeviceManager, SCSpectaclesDeviceNamer, SCSpectaclesDeviceStore, SCSpectaclesEventListenerAnnouncer, SCSpectaclesPairingManager, SCSpectaclesProfile, SCSpectaclesSensorStore;

@interface SCSpectaclesManager : NSObject <SCSpectaclesDeviceStoreDelegate, SCCacheClearing, SCSpectaclesContextNotificationTaskHandler>
{
...
- (void)shareWifiCredentials:(id)arg1 SSID:(id)arg2 password:(id)arg3;
...
- (void)setupPairingManager;
- (void)setupCentralManager;
- (void)dealloc;
- (id)initWithSpectaclesProfile:(id)arg1 crashLogger:(id)arg2 analyticsLogger:(id)arg3 tweaksConfigProvider:(id)arg4;
- (void)crashDetected;
