...
#import "SCUcoAppliedImageContainer.h"
...
@property(nonatomic) _Bool showPostSavePrompt; // @synthesize showPostSavePrompt=_showPostSavePrompt;
...
- (_Bool)isQuickSend;
- (_Bool)isSnap3DWithLiveCameraLens;
- (_Bool)isSnap3D;
