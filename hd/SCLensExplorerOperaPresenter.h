...
#import "SCLensExplorerOperaPresenterProtocol.h"
#import "SCOperaPresenterDelegate.h"

@class NSString, SCDiscoverFeedMiniProfileHandler, SCDiscoverFeedOperaSession, SCDiscoverFeedUnifiedProfileActionHandler, SCLazy, SCLensExplorerOperaLoggerListener, SCLensExplorerStoryPlayerContext, SCOperaPlaylistFeaturePlugin<SCOperaPlaylistFeaturePluginShouldUseExtendedResetToCamera>, SCUserSession;
