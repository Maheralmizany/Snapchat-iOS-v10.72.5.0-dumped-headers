...
#import "SCSearchDiscoverStoriesPresenterDelegate.h"
...
- (void)_playFriendStoryWithSummaryInfo:(id)arg1 withSourceView:(id)arg2 isCircleTransition:(_Bool)arg3;
- (void)_playFriendStory:(id)arg1 withSourceView:(id)arg2 isCircleTransition:(_Bool)arg3;
