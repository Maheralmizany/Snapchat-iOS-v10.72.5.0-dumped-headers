...
- (void)dataController:(SCOnDemandGeofilterDataController *)arg1 didFinishHomeFilterVisibilityUpdateWithExpectedValue:(_Bool)arg2 success:(_Bool)arg3 error:(NSString *)arg4;
- (void)dataController:(SCOnDemandGeofilterDataController *)arg1 didFinishHomeFilterUpdateWithRequest:(SOJUUnlockablesOndemandUpdateHomeFilterRequest *)arg2 response:(SOJUUnlockablesOndemandUpdateHomeFilterResponse *)arg3 success:(_Bool)arg4 error:(NSString *)arg5;
