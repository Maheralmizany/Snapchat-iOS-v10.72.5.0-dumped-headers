...
@class NSString, SCCommerceCheckoutSummaryViewModel, SCCommerceOrder, SCCommerceSession, SCGalleryPopsPrintThumbnailProvider, SCUserSession, UIView;
...
@interface SCCommerceOrderDetailsViewController : SCPaymentsGenericTableViewController <SCCommerceLoggerPageMetricsDataSource>
{
    ...
    SCGalleryPopsPrintThumbnailProvider *_thumbnailProvider;
