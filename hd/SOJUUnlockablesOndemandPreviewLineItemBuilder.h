...
@interface SOJUUnlockablesOndemandPreviewLineItemBuilder : NSObject
{
    NSString *_idValue;
...
+ (id)withJUUnlockablesOndemandPreviewLineItem:(id)arg1;
- (void).cxx_destruct;
- (id)setOrgCurrency:(id)arg1;
- (id)setShouldAvoidOrgApiCalls:(id)arg1;
...
- (id)build;
- (id)setOrgCurrencyEnum:(long long)arg1;
- (id)setShouldAvoidOrgApiCallsValue:(_Bool)arg1;
