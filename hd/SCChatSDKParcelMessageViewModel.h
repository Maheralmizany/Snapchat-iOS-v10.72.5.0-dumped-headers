...
#import "SCMergeableViewModelProtocol.h"
#import "SCStackableViewModelProtocol.h"
...
- (_Bool)isMessageAtIndex:(unsigned long long)arg1 savedByUserIdentifier:(id)arg2;
