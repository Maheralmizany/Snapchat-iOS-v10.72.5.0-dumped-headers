...
@class NSArray, NSString, SCDisposableObserver, SCLocationShareWithFriendController, SCUserSession;

@interface SCChatLocationSharingController : NSObject <SCMapPersonLocationsListener, SCMapPeopleFriendsListener, SCLocationShareWithFriendControllerShareFlowDelegate>
{
    NSArray *_cellTypes;
    _Bool _isGroup;
    NSString *_groupId;
