...
@interface SCUserStoryShareDataModel : NSObject <NSCopying>
{
    _Bool _isUserTagged;
    NSString *_storyId;
...
- (id)initWithStoryId:(id)arg1 mediaType:(long long)arg2 isUserTagged:(_Bool)arg3 additionalText:(id)arg4;
