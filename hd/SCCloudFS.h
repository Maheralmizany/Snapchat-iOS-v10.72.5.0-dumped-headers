...
@class NSDictionary, NSMutableDictionary, NSObject<OS_dispatch_semaphore>, NSSet, NSString, NSURL, SCCacheSizePolicy, SCCloudFSDiskUsedListenerAnnouncer, SCCloudFSLRUQueue, SCDataObjectContext, SCExperimentManager, SCMediaDownload;
