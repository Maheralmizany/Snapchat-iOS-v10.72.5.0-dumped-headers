...
- (void)_logDisplayError:(long long)arg1 startTimestamp:(double)arg2;
- (void)_logLoadStep:(long long)arg1 startTimestamp:(double)arg2 result:(long long)arg3;
- (void)_logLoadStep:(long long)arg1 startTimestamp:(double)arg2 success:(_Bool)arg3;
- (void)_logFetchStepStart:(double)arg1 success:(_Bool)arg2;
...
- (void)_emitShakeToReportForNilThumbnailImageData:(id)arg1;
- (void)_fetchImageFromCacheWithMediaCategory:(long long)arg1 completionQueue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
