...
@property(readonly, copy, nonatomic) NSNumber *pageCurrentOffset;
@property(readonly, copy, nonatomic) NSNumber *pageHeightSeen;
@property(readonly, copy, nonatomic) NSNumber *pageHeight;
