...
- (void)_logApplicationLoginWithSource:(long long)arg1 username:(id)arg2 userId:(id)arg3;
...
- (void)logApplicationLoginWithSource:(long long)arg1 username:(id)arg2 userId:(id)arg3;
