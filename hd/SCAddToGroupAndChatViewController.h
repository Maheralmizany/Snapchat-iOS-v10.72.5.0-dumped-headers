...
@class NSString, SCChatMainViewController, SCInvalidFriendAlertView, SCLazy, SCNewGroupViewController, SCSendToDocObjectRecipientDataSource, SCSendToNewGroupDataRepository, SCUserSession, UITapGestureRecognizer, UIViewController<SwipeView>;
...
- (void)completeModalPresentation;
