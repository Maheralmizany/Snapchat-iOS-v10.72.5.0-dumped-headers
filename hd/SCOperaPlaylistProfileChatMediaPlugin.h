...
@class SCProfileChatMediaOperaDataSource, SCUserSession;

@interface SCOperaPlaylistProfileChatMediaPlugin : SCOperaPlaylistFeaturePlugin
{
...
- (id)initWithUserSession:(id)arg1 initialChatMedia:(id)arg2 dataSource:(id)arg3;
