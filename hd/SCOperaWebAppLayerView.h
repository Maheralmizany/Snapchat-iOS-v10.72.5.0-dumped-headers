...
#import "SCOperaWebAppLoadingViewDelegate.h"
#import "SCSecretFeatureCheckerListener.h"

@class NSString, NSURL, SCEventListenerAnnouncer, SCOperaWebAppInteractionView, SCOperaWebAppLoadingView, SCSecretFeatureChecker, WKWebView;
