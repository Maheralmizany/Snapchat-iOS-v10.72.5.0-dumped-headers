...
@class NSString, SCGradientView, SCLazy, SCNetworkImageView, UILabel;

@interface SCDiscoverFeedOnboardingTileCell : UICollectionViewCell <SCActionable, SCViewModelConfigurable>
{
