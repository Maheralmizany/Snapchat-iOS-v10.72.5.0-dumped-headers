...
+ (id)newWithUserSession:(id)arg1 delegate:(id)arg2 userAdaptor:(id)arg3 promptStateProvider:(id)arg4;
...
- (id)initWithUserSession:(id)arg1 delegate:(id)arg2 userAdaptor:(id)arg3 promptStateProvider:(id)arg4;
