...
#import "SCMediaSendTask.h"

@class NSDate, NSMutableArray, NSString, SCFuture, SCMediaGroupSendTaskWaitingGroup, SCMediaSendTaskConfiguration, SCMediaSendTaskEphemeralMedia, SCMediaSendTaskMediaList, SCMediaSendTaskMetricsProperties, SCMediaSendTaskUploadGroup, SCQueuePerformer, Snap, Story;
...
- (void)_endPostStoryStepWithClientId:(id)arg1;
