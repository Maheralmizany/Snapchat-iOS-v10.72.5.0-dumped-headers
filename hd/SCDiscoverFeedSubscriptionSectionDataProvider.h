...
@class NSArray, NSObject<NSCopying>, NSString, SCDiscoverFeedDataStore, SCDiscoverFeedSectionHeaderViewModel, SCDiscoverFeedSectionViewAllButtonStates, SCEventListenerAnnouncer, SCUserSession;
