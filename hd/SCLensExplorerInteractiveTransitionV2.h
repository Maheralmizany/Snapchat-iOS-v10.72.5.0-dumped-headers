...
#import "SCLensExplorerInteractiveTransitionProtocol.h"

@class NSString, UIPercentDrivenInteractiveTransition, UIViewController<SCLensExplorerTransitioningViewControllerProtocol>;
