...
#import "SCViewControllerPresentationAnimator.h"

@class CALayer, NSString, UIView, UIViewController;

@interface SCViewControllerPresentationThumbnailAnimator : NSObject <SCViewControllerPresentationAnimator>
{
    ...
    _Bool _needToCreateMaskViewWhenBaseViewIsUpdated;
...
- (void)_restoreBaseViewForAnimation;
- (void)_prepareBaseViewForAnimation;
- (void)updateBaseView:(id)arg1;
- (void)setupAnimationForBaseView:(id)arg1;
- (void)animateTransition:(_Bool)arg1;
- (id)initWithParentViewController:(id)arg1 childViewController:(id)arg2 baseView:(id)arg3 baseViewBehavior:(long long)arg4 baseViewOrientation:(long long)arg5 isCircleTransition:(_Bool)arg6;
