...
- (id)initWithBrowseStyle:(unsigned long long)arg1 isFromStoryV2Tab:(_Bool)arg2 isFeatured:(_Bool)arg3 shouldShowAddressOnChrome:(_Bool)arg4 dataObjectContext:(id)arg5;
- (id)initWithBrowseStyle:(unsigned long long)arg1 dataObjectContext:(id)arg2;
