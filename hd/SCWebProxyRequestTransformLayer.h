...
@interface SCWebProxyRequestTransformLayer : SCWebProxyLayer
{
    id <SCWebProxyRequestTransformLayerDelegate> _delegate;
}

@property(readonly, nonatomic) __weak id <SCWebProxyRequestTransformLayerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
