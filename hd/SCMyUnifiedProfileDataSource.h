...
@class NSArray, NSString, NSURL, SCLazy, SCNetworkImage, SCQueuePerformer, SCUpdateListenerAnnouncer;
...
- (id)initWithUserId:(id)arg1 snapchattersDataFetcher:(id)arg2;
