...
#import "SCOperaShakeToReportOperator.h"
#import "SCSIGShakeReportDelegate.h"
#import "SCShakeReportDelegate.h"

@class NSString, SCAlertView, SCEventListenerAnnouncer, SCLazy, SCOperaViewController, UIViewController, UIWindow;

@interface SCShakePromptCoordinator : NSObject <FBTweakViewControllerDelegate, SCShakeReportDelegate, SCOperaShakeToReportOperator, SCBetaShakeReportViewControllerDelegate, SCSIGShakeReportDelegate>
{
