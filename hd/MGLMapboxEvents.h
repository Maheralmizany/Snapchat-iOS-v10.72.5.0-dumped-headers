...
#import "MGLLocationManagerDelegate.h"

@class MGLAPIClient, MGLLocationManager, MGLMapboxEventsData, NSDate, NSDateFormatter, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NSTimer;
