...
#import "SCOperaPropertyUpdateModerator.h"
...
- (id)_layerVCForLayer:(id)arg1 inLayerVCs:(id)arg2;
...
- (_Bool)isOverlay;
- (void)_shrinkMediaContainerLayersWithScale:(double)arg1 duration:(double)arg2;
