...
- (id)initWithSource:(long long)arg1 itemLayout:(long long)arg2 interactionContext:(long long)arg3 fieldsOverrideDict:(id)arg4 discoverFeedCollection:(id)arg5 discoverFeedDataFetcher:(id)arg6;
