...
#import "SOJUUnlockablesOndemandTemplateTextBox.h"

@class NSNumber, NSString, SOJUUnlockablesOndemandTextShadowParametersList;

@interface SOJUUnlockablesOndemandTemplateTextBox : NSObject <SOJUUnlockablesOndemandTemplateTextBox>
{
    NSNumber *_posX;
    NSNumber *_posY;
    NSString *_fontName;
...
@property(readonly, copy, nonatomic) NSString *fontColor; // @synthesize fontColor=_fontColor;
...
- (id)initWithPosX:(id)arg1 posY:(id)arg2 fontName:(id)arg3 fontUrl:(id)arg4 fontSize:(id)arg5 defaultText:(id)arg6 rotation:(id)arg7 zPriority:(id)arg8 textAlignment:(id)arg9 shadowIndex:(id)arg10 presetStylizedTextId:(id)arg11 textShadowParametersList:(id)arg12 width:(id)arg13 height:(id)arg14 fontColor:(id)arg15;
- (id)toJson;
- (id)toDictionary;
