...
#import "SCWebBrowsingURLInterceptorDataSource.h"

@class NSDate, NSNumber, NSString, NSURL, SCWebBrowserLayerView, UIViewController<SCWebBrowser>;
...
@interface SCWebBrowserLayerViewController : SCOperaLayerViewController <SCWebBrowserDelegate, SCWebBrowsingURLInterceptorDataSource>
{
    ...
    NSDate *_browserDidEndSessionWithoutDismissingSelfTimestamp;
