...
- (void)_completeExportWithAsset:(id)arg1 contentCreateTimeUtc:(id)arg2;
...
- (_Bool)_shouldUseSpectaclesExport;
- (_Bool)_canExportRawVideoTrack:(id)arg1 outputBitrate:(long long)arg2;
