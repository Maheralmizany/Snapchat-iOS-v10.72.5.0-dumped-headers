...
- (void)boostMediaDownloadRequestForConversationId:(NSString *)arg1 messageId:(NSString *)arg2 messageBodyType:(long long)arg3 media:(SCChatMediaContent *)arg4 senderUsername:(NSString *)arg5 useBoltUpload:(_Bool)arg6;
- (void)sendMediaDownloadRequestForConversationId:(NSString *)arg1 messageId:(NSString *)arg2 messageBodyType:(long long)arg3 media:(SCChatMediaContent *)arg4 senderUsername:(NSString *)arg5 lensMetadata:(NSString *)arg6 userInitiated:(_Bool)arg7 useBoltUpload:(_Bool)arg8 successBlock:(void (^)(void))arg9 failureBlock:(void (^)(long long))arg10;
@end
