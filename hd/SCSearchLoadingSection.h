...
@class NSArray, NSString, NSValue, SCCollectionViewSectionUpdateModel, SCSearchQueryStateAwareSupplementaryViewProvider;

@interface SCSearchLoadingSection : NSObject <SCCollectionViewSection>
{
