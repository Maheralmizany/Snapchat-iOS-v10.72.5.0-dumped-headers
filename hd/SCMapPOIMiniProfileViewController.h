...
#import "SCMiniProfileStoryIdentitySectionControllerDelegate.h"
...
@class NSString, SCArroyoGroupFilterer, SCMTPointOfInterest, SCMapLoggerSession, SCMapStoryViewModel, SCMapTapToPlayPOIMediaFetcher, SCOperaPresenter, SCScopedAccess, SCSendToTransitionProvider, SCUserSession;
...
- (void).cxx_destruct;
- (void)_sendToArroyoConversations:(id)arg1 additionalText:(id)arg2;
