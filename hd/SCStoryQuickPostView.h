...
#import "SCCustomStorySettingsViewControllerDelegate.h"
...
- (id)initWithUserSession:(id)arg1 postableStoriesProvider:(id)arg2 ourStoriesDescriptionProvider:(id)arg3 customStoriesDataMutator:(id)arg4 customStoriesDataFetcher:(id)arg5 includeBusinessProfiles:(_Bool)arg6 includeAppStory:(_Bool)arg7 miniProfileDelegate:(id)arg8 viewController:(id)arg9;
