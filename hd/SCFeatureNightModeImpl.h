...
#import "SCFeatureNightMode.h"
#import "SCManagedCapturerListener.h"

@class NSString, SCCameraToolbarItem, SCDisposableObserverLifecycle, SCFeatureReference, SCManagedCapturerState, UIView<SCFeatureContainerView>;
