...
@class NSObject<NSCopying>, NSString, SCEventListenerAnnouncer, SCLensExplorerSendToFlow, SCSearchQuery, SCSendToLatencyMetricLogger, SCSendToSelectionStateManager, SCSendToStoriesDataSource, SCUserSession;
