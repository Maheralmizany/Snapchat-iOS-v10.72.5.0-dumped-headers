...
@class NSData, NSString, SCFeature<SCFeatureSwipeFilters>, SCFeatureImageSmartSwipeFilters, SCFeatureVideoSmartSwipeFilters, SCPreviewConfiguration, SCPreviewView, SCSmartSwipeFilterView, UIView;
