...
#import "SCProfileChatMediaOperaPresenterDelegate.h"

@class NSString, SCLazy, SCProfileChatMediaDataSource, SCProfileChatMediaOperaPresenter, SCUnifiedActionMenuPresenter, SCUnifiedProfileLoggingService, SCUserSession, UIViewController<SCPageNameLogging>;
...
- (void)savedInChatMediaOperaPresenter:(id)arg1 didBeginPlayingChatMediaWithDataModel:(id)arg2;
- (void)savedInChatMediaOperaPresenterDidTearDown:(id)arg1;
- (void)_presentChatMedia:(id)arg1 baseView:(id)arg2 operaBaseViewProvider:(id)arg3;
