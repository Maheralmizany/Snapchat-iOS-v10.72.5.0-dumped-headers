...
@protocol SOJUFavoriteStickerInfo <NSObject, NSCoding, NSCopying>
@property(readonly, copy, nonatomic) NSNumber *lastUsed;
@property(readonly, copy, nonatomic) NSNumber *numTimesUsed;
