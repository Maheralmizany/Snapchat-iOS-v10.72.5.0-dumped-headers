...
#import "SCOperaPlaylistItemController.h"
...
- (void)removePlaylistItemGroupForID:(id)arg1;
...
- (id)_playlistBasedOnGroupDataModels:(id)arg1 initialGroupDataModel:(id)arg2 recommendedStoriesIds:(id)arg3;
