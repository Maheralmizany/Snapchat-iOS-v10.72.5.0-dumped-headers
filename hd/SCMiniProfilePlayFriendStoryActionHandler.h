...
@class NSString, SCContextOperaPlaylistPlugin, SCLazy, SCOperaPlaylistFeaturePlugin, SCOperaPresenter, SCUserSession, UIViewController<SCPageNameLogging>;
...
- (void)_playStoryWithStoriesSummaryInfo:(id)arg1 baseView:(id)arg2;
- (void)_playStoryForSnapchatter:(id)arg1 baseView:(id)arg2;
- (_Bool)handleActionWithSender:(id)arg1 actionModel:(id)arg2 fromSourceView:(id)arg3;
- (id)initWithUserSession:(id)arg1 storiesDataProvider:(id)arg2 storiesMediaCoordinator:(id)arg3 startChatDelegate:(id)arg4 navigationDelegate:(id)arg5;
