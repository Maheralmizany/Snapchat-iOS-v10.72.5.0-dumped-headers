...
@class NSString, SCFriendUnifiedActionMenuActionHandler, SCGroupUnifiedActionMenuActionHandler, SCImpalaPublicProfilePresenter, SCLazy, SCUnifiedActionMenuPresenter, SCUnifiedProfilePresenter, SCUserSession, UIViewController<SCPageNameLogging>;
