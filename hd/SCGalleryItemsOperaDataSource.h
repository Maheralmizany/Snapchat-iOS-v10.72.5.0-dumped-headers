...
#import "SCGallerySingleItemOperaDataSourceDelegate.h"

@class NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<SCGalleryOperaMagicMomentCaching>, NSString, SCGalleryOperaConfiguration, SCGalleryOperaMediaManager, SCOperaPerformanceTrackingPlugin, SCUserSession;
...
- (id)resolvePHAssetAtPage:(id)arg1;
