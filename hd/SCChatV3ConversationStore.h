...
#import "NSCoding.h"
#import "SCChatConversationStore.h"
#import "SCChatPrefetchResponseProcessing.h"
#import "SCTraceEnabled.h"

@class NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, NSString, SCChatConversationStoreListenerAnnouncer, SCChatV3FeedUpdater, SCChatV3MessageReceiver, SCConversationPrefetchReader, SCConversationPrefetchResponses, SCExperimentManager, SCLazy;
...
@interface SCChatV3ConversationStore : NSObject <SCChatConversationStore, NSCoding, SCTraceEnabled, SCChatPrefetchResponseProcessing>
{
    ...
    CDUnknownBlockType _prefetchCompletion;
    id <SCGraphene> _graphene;
    id <SCConversationOrdering> _conversationOrdering;
