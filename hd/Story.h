...
@property(copy) NSString *curationSourceStoryId; // @synthesize curationSourceStoryId=_curationSourceStoryId;
@property(copy) NSString *searchStoryId; // @synthesize searchStoryId=_searchStoryId;
...
- (void)_saveStoryDataToPersistentStoreWithData:(id)arg1 needToSaveToOldCache:(_Bool)arg2 completionQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;
