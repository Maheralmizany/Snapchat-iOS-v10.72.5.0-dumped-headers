...
@class NSString, SCExperimentManager, SCSearchNavigationCoordinator, SCSearchQuery;

@interface SCMyFriendsSearchQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
