...
@interface SOJUMessagePreservationMessage : NSObject <SOJUMessagePreservationMessage>
{
    SOJUHeader *_header;
    NSNumber *_retried;
...
@property(readonly, copy, nonatomic) NSNumber *preserved; // @synthesize preserved=_preserved;
...
- (id)initWithHeader:(id)arg1 retried:(id)arg2 knownChatSequenceNumbers:(id)arg3 mischiefVersion:(id)arg4 seqNum:(id)arg5 timestamp:(id)arg6 type:(id)arg7 idValue:(id)arg8 appEngineTarget:(id)arg9 chatMessageId:(id)arg10 preserved:(id)arg11 chatMessageSeqNum:(id)arg12;
- (id)toJson;
- (id)toDictionary;
