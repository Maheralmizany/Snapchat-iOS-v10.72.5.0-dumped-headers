...
- (id)initWithLabelText:(id)arg1 leftImage:(id)arg2 rightImage:(id)arg3 primaryTapActionModel:(id)arg4 secondaryTapActionModel:(id)arg5 cellHeight:(double)arg6 badgeViewModel:(id)arg7;
