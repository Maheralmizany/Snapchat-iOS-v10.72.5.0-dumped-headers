...
#import "SCImageCaptureConfiguration.h"
...
- (id)initWithExposureCaptureDeadline:(id)arg1 isStabilizationDisabled:(_Bool)arg2 aspectRatio:(double)arg3 captureSessionID:(id)arg4 shouldCaptureFromVideo:(_Bool)arg5 zoomFactor:(double)arg6 capturerState:(id)arg7 fieldOfView:(float)arg8 lensInitiatedCapture:(_Bool)arg9 isMainCamera:(_Bool)arg10;
