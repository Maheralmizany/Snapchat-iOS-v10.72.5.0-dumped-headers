...
@class AVAsset, NSArray, NSError, NSMutableArray, NSObject<OS_dispatch_semaphore>, NSString, NSURL, SCBatchCaptureConfiguration, SCBatchCaptureSegmentExportSession, SCMultiSnapVideoSegmentedExportSession, SCQueuePerformer, SCSentinel, SCUserSession;

@interface SCPreviewEphemeralMediaList : NSObject
{
    _Bool _isMultiSnap;
    NSURL *_videoURL;
    _Bool _isParallelTranscodeEnabled;
    NSObject<OS_dispatch_semaphore> *_exportSegmentSemaphore;
    NSObject<OS_dispatch_semaphore> *_transcodeSegmentSemaphore;
    SCQueuePerformer *_transcodingPerformer;
...
- (void).cxx_destruct;
- (void)_parallelTranscodeSegmentAtIndex:(unsigned long long)arg1 count:(unsigned long long)arg2;
- (void)_parallelExportSegmentAtIndex:(unsigned long long)arg1 count:(unsigned long long)arg2;
- (void)_cancelMultiSnapParallelTranscoding;
- (void)_startMultiSnapParallelTranscoding;
...
- (void)_setPrivateStoryInviteInfo:(id)arg1 inviteId:(id)arg2 onEphemeralMedia:(id)arg3;
- (void)setStoryInviteWithPublicationId:(id)arg1 inviteId:(id)arg2 storyName:(id)arg3 ephemeralMedia:(id)arg4;
