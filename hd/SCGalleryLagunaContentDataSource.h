...
#import "SCGalleryLagunaWifiControllerEventListener.h"
#import "SCSpectaclesEventListener.h"
#import "SCTraceEnabled.h"
#import "SCUserSessionScoped.h"

@class NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_semaphore>, NSSet, NSString, SCDataObjectContext, SCGalleryLagunaMetadataProvider, SCQueuePerformer, SCSentinel, SCUserSession;

@interface SCGalleryLagunaContentDataSource : NSObject <SCCloudSyncStatusListener, SCSpectaclesEventListener, SCTraceEnabled, SCGalleryLagunaWifiControllerEventListener, SCUserSessionScoped>
{
    _Bool _isSetup;
