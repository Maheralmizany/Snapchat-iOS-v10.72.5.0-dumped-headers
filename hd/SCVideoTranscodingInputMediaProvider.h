...
#import "SCVideoTranscodingInputMediaProvider.h"

@class AVAsset, NSDate, NSString, NSURL, SCImageProcessVideoExportStaticFrameConfig, UIImage;
...
@interface SCVideoTranscodingInputMediaProvider : NSObject <SCVideoTranscodingInputMediaProvider>
{
    ...
    double _duration;
    AVAsset *_inputImageAudioAsset;
    struct CGAffineTransform _videoTransform;
}

+ (unsigned long long *)fasterCodingKeys;
+ (unsigned long long)fasterCodingVersion;
@property(readonly, copy, nonatomic) AVAsset *inputImageAudioAsset; // @synthesize inputImageAudioAsset=_inputImageAudioAsset;
...
@property(readonly, copy, nonatomic) SCImageProcessVideoExportStaticFrameConfig *staticFrameConfig; // @synthesize staticFrameConfig=_staticFrameConfig;
...
- (id)initWithInputVideoAsset:(id)arg1 rawVideoDataURL:(id)arg2 videoOrientation:(long long)arg3 videoTransform:(struct CGAffineTransform)arg4 videoPlaybackRate:(double)arg5 videoCreateTimeUtc:(id)arg6 staticFrameConfig:(id)arg7 inputImage:(id)arg8 frameRate:(unsigned long long)arg9 duration:(double)arg10 inputImageAudioAsset:(id)arg11;
