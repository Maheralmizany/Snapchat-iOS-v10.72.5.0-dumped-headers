...
#import "SCFeatureVideoCapture.h"
#import "SCManagedCapturerListener.h"

@class NSString, SCAudioConfiguration, SCAudioConfigurationToken, SCCoreCameraLogger, SCFrameProcessLatencyReporter, SCFuture, SCHapticsManager, SCManagedCapturerState, SCManagedVideoNoSoundLogger, SCQueuePerformer, SCRecordingFileManager, SCUserSession, SCVideoCaptureConfiguration, UIView<SCFeatureContainerView>;
