...
+ (id)MessageWithDescriptor:(id)arg1 senderId:(id)arg2 messageContent:(id)arg3 metadata:(id)arg4 releasePolicy:(long long)arg5 state:(long long)arg6 messageAnalytics:(id)arg7;
@property(readonly, nonatomic) SCNMessagingMessageAnalytics *messageAnalytics; // @synthesize messageAnalytics=_messageAnalytics;
...
- (id)initWithDescriptor:(id)arg1 senderId:(id)arg2 messageContent:(id)arg3 metadata:(id)arg4 releasePolicy:(long long)arg5 state:(long long)arg6 messageAnalytics:(id)arg7;
