...
#import "SCFailedStoryPostTooltipDelegate.h"
#import "SCHovaNavigationBarDataSource.h"
#import "SCHovaNavigationBarDelegate.h"
#import "SCHovaOverscrollControllerDelegate.h"
#import "SCHovaStatusBarControllerDataSource.h"
#import "SCIdleMonitorScrollController.h"
#import "SCInAppNotificationInteractionDelegate.h"
#import "SCPageNameLogging.h"
#import "SCRequestManagerDelegate.h"
...
#import "SCTabBarViewDataSource_DEPRECATED.h"
#import "SCTabBarViewDelegate_DEPRECATED.h"
...
@class MainViewControllerInternalState, MainViewControllerStartupWorkflow, NSMutableSet, NSString, SCAddFriendsButtonBadgeUpdater, SCChatMainViewController, SCCommerceOperaPresenter, SCDiscoverFeedDeeplinkHandler, SCFeedToChatTapDetectionView, SCHovaNavigationBar, SCHovaStatusBarController, SCHovaTabBarView, SCMainCameraViewController<SwipeView>, SCMainScrollView, SCOpenAddFriendsCardActionHandler, SCUserSession, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIView, UIViewController<SCFeedPage><SCPageNameLogging>, UIViewController<SCStoriesPage><SCPageNameLogging>, UIViewController<SwipeView><SCPageNameLogging>;

@interface MainViewController : UIViewController <SCRequestManagerDelegate, NavigationDelegate, SCStartChatDelegate, SCTraceEnabled, SCHovaNavigationBarDataSource, SCSearchViewDelegate, SCHovaStatusBarControllerDataSource, SCHovaOverscrollControllerDelegate, SCUnifiedProfileTransitionCoordinatorDelegate, SCUnifiedProfileTransitionCoordinatorDataSource, SCIdleMonitorScrollController, SCUnifiedProfileViewControllerDelegate, SCSpectaclesPairingDelegate, SCFailedStoryPostTooltipDelegate, SCHovaNavigationBarDelegate, SCTCKNavigationServices, SCDataCoordinatorListener, NavigationPageState, SCSearchV2WorkflowDelegate, UIScrollViewDelegate, SCCameraViewControllerDelegate, SendSnapNavigationControllerDelegate, SCSwipeViewParentDelegate, UIGestureRecognizerDelegate, SCPageNameLogging, SCTabBarViewDelegate_DEPRECATED, SCTabBarViewDataSource_DEPRECATED, SCInAppNotificationInteractionDelegate, SCApplicationLifecycleNavigationHandler>
{
...
- (void)loadView;
- (void)dealloc;
- (id)initWithCapturerToken:(id)arg1 userSession:(id)arg2 discoverFeedScopeExposer:(id)arg3 friendsFeedScopeExposer:(id)arg4 cameraScopeExposer:(id)arg5 searchV2ScopeExposer:(id)arg6;
