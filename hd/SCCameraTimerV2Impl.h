...
@class CADisplayLink, CALayer, NSString, POPAnimatableProperty, SCCameraTimerTooltipManager, SCCameraTimerV2SpinnerView, SCShapeView, SCSnappablesPlayButton, UIImageView;
...
- (void)_performTouchDownHaptic:(_Bool)arg1;
