...
@class NSArray, NSDate, NSNumber, NSString, NSURL, SCCDGalleryEntry, SCCDGalleryProfile, SCCDGallerySnapDetail, SCCDGallerySnapID, SCCDGallerySnapMiniThumbnail, SOJUGalleryServletSensorBlob, SOJUSnapCreatorAttribution, SOJUStoryFrame;
...
@property(retain, nonatomic) SOJUSnapCreatorAttribution *creatorAttribution; // @dynamic creatorAttribution;
...
@property(retain, nonatomic) SOJUStoryFrame *framing; // @dynamic framing;
...
@property(retain, nonatomic) NSArray *mediaAttributes; // @dynamic mediaAttributes;
...
@property(retain, nonatomic) SOJUGalleryServletSensorBlob *sensorBlob; // @dynamic sensorBlob;
...
@property(retain, nonatomic) NSNumber *sojuMediaType; // @dynamic sojuMediaType;
...
@property(retain, nonatomic) NSURL *thumbnailURI; // @dynamic thumbnailURI;
...
@property(retain, nonatomic) NSArray *toolVersions; // @dynamic toolVersions;
