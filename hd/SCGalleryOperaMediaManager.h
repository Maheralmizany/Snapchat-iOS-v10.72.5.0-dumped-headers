...
#import "SCOperaGLCommandsProvider.h"
...
- (id)_cacheGLCommandsAndGeneratePagePropertiesForSnap:(id)arg1 midOutputGLCommand:(id)arg2 magicMomentMidOutputGLCommand:(id)arg3 outputGLCommands:(id)arg4 magicMomentOutputGLCommands:(id)arg5;
...
- (id)_loadedPropertyForImageSnap:(id)arg1 snapDetail:(id)arg2 image:(id)arg3 outputCommands:(id)arg4 midOutputGLCommand:(id)arg5 magicMomentOutputGLCommands:(id)arg6 magicMomentMidOutputGLCommand:(id)arg7 isFullResolution:(_Bool)arg8 mediaOverlay:(id)arg9 screenOverlay:(id)arg10 lensAssets:(id)arg11;
