...
@class NSArray, NSObject<NSCopying>, NSString, SCAddFriendsSnapchatterDataProvider, SCEventListenerAnnouncer, SCLazy, SCPreferences, SCScopedAccess, SCSearchFriendsDataProvider, SCSearchSession;
