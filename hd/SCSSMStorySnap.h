...
@class NSData, NSMutableArray, NSString, SCConnectSnapConnectAttributes, SCSCOREMultiSnapExtension, SCSCORESnapSource, SCSSMSnapCreatorInfo, SCSSMSnapFragmentMetadata, SCSSMSnapMediaInfo, SCSSMSnapPivotInfo, SCSSMStoryThumbnail;
...
@property(nonatomic) _Bool hasSnapConnectAttributes; // @dynamic hasSnapConnectAttributes;
...
@property(retain, nonatomic) SCConnectSnapConnectAttributes *snapConnectAttributes; // @dynamic snapConnectAttributes;
...
@property(nonatomic) long long sourceCreationTimestamp; // @dynamic sourceCreationTimestamp;
