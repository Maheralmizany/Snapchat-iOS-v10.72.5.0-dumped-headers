...
- (id)initWithBadgeId:(id)arg1 badgeType:(long long)arg2 badgeMetadata:(id)arg3 renderInfo:(id)arg4 tapDestination:(id)arg5 fetchedTimestampInSec:(double)arg6 serverNextRequestTimestampInSec:(double)arg7;
