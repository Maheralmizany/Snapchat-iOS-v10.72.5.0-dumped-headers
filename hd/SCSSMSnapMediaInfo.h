...
@class NSString, SCMTPublicMediaInfo, SCMTStreamingMediaInfo, SCSSMSnapBoltInfo;

@interface SCSSMSnapMediaInfo : GPBMessage
{
}
...
@property(nonatomic) _Bool hasSnapBoltInfo; // @dynamic hasSnapBoltInfo;
...
@property(retain, nonatomic) SCSSMSnapBoltInfo *snapBoltInfo; // @dynamic snapBoltInfo;
