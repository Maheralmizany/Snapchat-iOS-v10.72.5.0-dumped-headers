...
@class EGODatabaseStatement, NSArray, NSSet, NSString, SCCloudSync, SCDataObjectContext, SCExperimentManager, SCGalleryLogger, SCGalleryProfile, SCGallerySearchIndexer, SCGallerySearchTagUploader, SCKeyService, SCMemoriesSearchDatabase, SCQueuePerformer, SCSentinel;
