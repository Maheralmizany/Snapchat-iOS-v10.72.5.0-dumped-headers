...
+ (id)actionMenuOptionForSnapWithEntryType:(int)arg1 isFailedEntry:(_Bool)arg2 isEntryClientCompatible:(_Bool)arg3 isPrivate:(_Bool)arg4 isPendingSync:(_Bool)arg5 isBoomboxEnabled:(_Bool)arg6 isPopsPrintEnabled:(_Bool)arg7 userSession:(id)arg8;
