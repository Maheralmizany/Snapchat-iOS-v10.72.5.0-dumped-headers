...
#import "SOJUMessageEraseMessage.h"

@class NSDictionary, NSNumber, NSString, SOJUHeader;

@interface SOJUMessageEraseMessage : NSObject <SOJUMessageEraseMessage>
{
    SOJUHeader *_header;
    NSNumber *_retried;
...
- (id)initWithHeader:(id)arg1 retried:(id)arg2 knownChatSequenceNumbers:(id)arg3 mischiefVersion:(id)arg4 seqNum:(id)arg5 timestamp:(id)arg6 type:(id)arg7 idValue:(id)arg8 appEngineTarget:(id)arg9 chatMessageId:(id)arg10 chatMessageSeqNum:(id)arg11 chatMessageSenderId:(id)arg12;
- (id)toJson;
- (id)toDictionary;
