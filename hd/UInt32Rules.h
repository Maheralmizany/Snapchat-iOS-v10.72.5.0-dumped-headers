...
@property(nonatomic) unsigned int const_p; // @dynamic const_p;
@property(nonatomic) unsigned int gt; // @dynamic gt;
@property(nonatomic) unsigned int gte; // @dynamic gte;
...
@property(retain, nonatomic) GPBUInt32Array *inArray; // @dynamic inArray;
@property(readonly, nonatomic) unsigned long long inArray_Count; // @dynamic inArray_Count;
@property(nonatomic) unsigned int lt; // @dynamic lt;
@property(nonatomic) unsigned int lte; // @dynamic lte;
@property(retain, nonatomic) GPBUInt32Array *notInArray; // @dynamic notInArray;
