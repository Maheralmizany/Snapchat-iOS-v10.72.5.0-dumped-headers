...
@interface SCMapLoadingStateListenerAnnouncer : NSObject <SCMapLoadingStateListener>
{
    struct mutex _mutex;
    struct shared_ptr<std::__1::vector<__weak id<SCMapLoadingStateListener>, std::__1::allocator<__weak id<SCMapLoadingStateListener>>>> _listeners;
}
