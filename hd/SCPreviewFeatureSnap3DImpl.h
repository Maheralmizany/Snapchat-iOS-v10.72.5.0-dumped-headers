...
#import "SCPreviewFeatureSnap3D.h"
#import "SCPreviewFeatureSnap3DLensFiltersProviderDelegate.h"

@class NSString, SCFriendsPageOnboardingView, SCFuture, SCImageProcessSnap3DLensCommand, SCLens, SCLensUriServiceProvider, SCLensUriServiceSnap3DRemoteDataHandler, SCPreviewConfiguration, SCPreviewFeatureSnap3DLensFiltersProvider, SCPreviewSnap3DRemoteAssetsProvider, SCPreviewView, SCSmartCarouselFilterArranger, SCSnap3DPreviewFiltersTooltip, SCTimeProvider, SCUserSession;
...
@interface SCPreviewFeatureSnap3DImpl : SCFeature <SCLensDataFetcherListener, SCPreviewFeatureSnap3DLensFiltersProviderDelegate, SCImageProcessLensCommandListener, SCPreviewFeatureSnap3D>
{
    ...
    SCSnap3DPreviewFiltersTooltip *_tooltip;
