...
#import "SOJUGalleryInfoStickerStyle.h"
...
@property(readonly, copy, nonatomic) SOJUGalleryStoryInviteStickerStyle *storyinvite; // @synthesize storyinvite=_storyinvite;
