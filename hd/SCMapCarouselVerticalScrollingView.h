...
@interface SCMapCarouselVerticalScrollingView : SCTransparentParentView <UIGestureRecognizerDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
{
    ...
    id <SCMapCarouselVerticalScrollingViewDelegate> _delegate;
    UICollectionView *_collectionView;
}

@property(readonly, nonatomic) UICollectionView *collectionView; // @synthesize collectionView=_collectionView;
@property(nonatomic) __weak id <SCMapCarouselVerticalScrollingViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) struct CGRect topCellFrame;
