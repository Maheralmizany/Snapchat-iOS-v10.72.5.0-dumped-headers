...
- (id)initWithGroupInviteId:(id)arg1 groupId:(id)arg2 inviteId:(id)arg3 bottomOffset:(double)arg4 refreshCount:(double)arg5;
- (id)initWithGroupInviteId:(id)arg1 groupId:(id)arg2 inviteId:(id)arg3 isEventProfile:(id)arg4 bottomOffset:(double)arg5 refreshCount:(double)arg6;
- (id)initWithGroupInviteId:(id)arg1 groupId:(id)arg2 inviteId:(id)arg3 isEventProfile:(id)arg4 isEventSheet:(id)arg5 bottomOffset:(double)arg6 refreshCount:(double)arg7;
