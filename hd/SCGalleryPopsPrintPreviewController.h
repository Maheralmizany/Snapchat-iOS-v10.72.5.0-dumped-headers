...
@class NSArray, NSString, SCDataObjectContext, SCGalleryOnDemandResources, SCGalleryPopsPrintHelper, SCPlayerView, SCQueuePerformer, SCUserSession, SIGButton, SIGLoadingIndicatorView, SOJUCommerceProductInfo, UILabel;
