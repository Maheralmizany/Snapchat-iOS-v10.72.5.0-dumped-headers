...
@class NSArray, NSString, SCContextOperaPlaylistPlugin, SCContextV2Session, SCEventListenerAnnouncer, SCLazy, SCOperaInlinePrefetcherPlugin, SCOperaPlaylistPlugin, SCOperaPresenter, SCOperaViewInteraction, SCSearchDynamicStory, SCUpdateListenerAnnouncer, SCUserSession, SCViewControllerTransitionAnimator, UIView;
...
- (void).cxx_destruct;
- (void)_presentOperaWithDataModels:(id)arg1 playlistPlugin:(id)arg2 fromBaseView:(id)arg3 isCircleTransition:(_Bool)arg4;
...
- (void)_presentFriendStories:(id)arg1 fromBaseView:(id)arg2 isDeepLink:(_Bool)arg3 isCircleTransition:(_Bool)arg4;
- (void)presentFriendStories:(id)arg1 fromBaseView:(id)arg2 isCircleTransition:(_Bool)arg3;
- (void)presentStoryWtihSummaryInfo:(id)arg1 sourceView:(id)arg2 isCircleTransition:(_Bool)arg3;
