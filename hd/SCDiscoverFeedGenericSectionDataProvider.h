...
@class NSArray, NSObject<NSCopying>, NSString, SCDiscoverFeedSectionHeaderViewModel, SCEventListenerAnnouncer, SCExperimentManager, SCStreamingMediaManager, UIColor;
