...
#import "SOJUGalleryServletPrintSnapResult.h"

@class NSNumber, NSString;

@interface SOJUGalleryServletPrintSnapResult : NSObject <SOJUGalleryServletPrintSnapResult>
{
    NSString *_snapId;
...
@property(readonly, copy, nonatomic) NSString *printUrl; // @synthesize printUrl=_printUrl;
