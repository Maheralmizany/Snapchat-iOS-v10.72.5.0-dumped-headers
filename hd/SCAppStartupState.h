...
#import "SCAppStartupStateProtocol.h"
...
@property(readonly, nonatomic) SCAppNotification *sourceNotification; // @synthesize sourceNotification=_sourceNotification;
...
- (id)initWithSourceNotification:(id)arg1 headlessMode:(_Bool)arg2 appDelegate:(id)arg3 appDelegateProperties:(id)arg4 application:(id)arg5 launchOptions:(id)arg6 applicationState:(long long)arg7 preAppOpenLatency:(double)arg8;
