...
@class NSMutableArray, SDMAttachments, SDMAttribution, SDMCaptureCharacteristics, SDMCreativeKitSourceApp, SDMCreativeToolsAnalytics, SDMLegacyMultisnap, SDMLens, SDMPackaging, SDMPermittedUserActions, SDMPlayback, SDMSnapDoc_ID, SDMSpectacles, SDMThumbnail, SDMTiming, SDMUnlockables;
