...
#import "SCChatMessageV3.h"

@class NSArray, NSDate, NSDictionary, NSNumber, NSSet, NSString, SCChatMediaContent, SCChatMediaSave, SCChatMessageMetadata, SCChatMessageParticipantIdentifier;
