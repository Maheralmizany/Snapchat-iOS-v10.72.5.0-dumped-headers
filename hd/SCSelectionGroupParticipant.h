...
@interface SCSelectionGroupParticipant : NSObject <NSCopying>
{
    NSString *_userId;
    NSString *_username;
...
- (id)initWithUserId:(id)arg1 username:(id)arg2 displayName:(id)arg3 color:(id)arg4 bitmojiAvatarId:(id)arg5 bitmojiSelfieId:(id)arg6;
