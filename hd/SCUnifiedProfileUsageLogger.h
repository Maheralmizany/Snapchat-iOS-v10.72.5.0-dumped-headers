...
- (void).cxx_destruct;
- (long long)_getFriendshipStatus;
...
- (void)_logMyProfileUnifiedProfileActionWithActionIdentifier:(id)arg1;
- (void)_logMyProfileAction:(id)arg1;
- (void)_logGroupProfileUnifiedProfileActionWithActionModel:(id)arg1;
- (void)_logGroupProfileAction:(id)arg1;
- (void)_logProfileActionGrapheneMetricForProfileType:(long long)arg1 actionModel:(id)arg2;
- (void)_logFriendProfileUnifiedProfileActionWithActionModel:(id)arg1;
...
- (id)initWithProfileType:(unsigned long long)arg1 sourcePageType:(id)arg2 sessionId:(id)arg3 profileIdentifier:(id)arg4 messagingInfra:(long long)arg5;
