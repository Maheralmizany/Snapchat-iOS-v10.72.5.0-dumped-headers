...
@class NSObject<OS_dispatch_queue>, SCAuthenticatedNetworkServices, SCEntryPointCleanup, SCFriendmojiServices, SCLazy, SCLegacySnapchatterServices, SCServicesExposer, SCShakeToReportServices, SCSystemScope, SCUserSessionScope, SCUserStorageServices;
