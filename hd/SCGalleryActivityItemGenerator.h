...
@interface SCGalleryActivityItemGenerator : NSObject <SCStoryExporterDelegate, SCEventListener>
{
...
- (id)_errorWithFunctionName:(id)arg1 functionName:(id)arg2;
...
- (void)_generateItemForActivityItemProviderV2:(id)arg1 progressHandler:(CDUnknownBlockType)arg2 resultHandler:(CDUnknownBlockType)arg3;
