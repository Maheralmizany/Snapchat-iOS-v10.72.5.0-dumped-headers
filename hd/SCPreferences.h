...
#import "SCLensPreferences.h"

@class NSArray, NSDate, NSDictionary, NSNumber, NSSet, NSString, SCBloopsRemoteSettingsModel, SCFideliusTempDeviceUserInfo, SOJULoginResponse, UIImage;

@interface SCPreferences : NSObject <SCLensPreferences>
{
}
