...
@class CADisplayLink, FriendStories, FriendStoriesCollection, NSArray, NSMutableArray, NSMutableSet, NSString, SCAttachmentsLogger, SCDiscoverFeedMiniProfileHandler, SCDiscoverSubscriptionSession, SCLegacyStoriesChromeInteractionSession, SCLegacyStoriesReportSession, SCLegacyStoriesSharingSession, SCObservable, SCOperaEventListenerAnnouncer, SCOperaPerformanceTrackingPlugin, SCOperaPlaybackIntentToNextTrackingPlugin, SCOperaViewController, SCStoriesViewersInteractionSession, SCStoryDiagnosticsLogger, SCStoryLogger, SCStoryUsageLogger, SCStoryUserProperties, SCUserSession, Story, User;
...
- (void)startSession;
- (id)initWithUserSession:(id)arg1 user:(id)arg2 startChatDelegate:(id)arg3 friendStoriesCollection:(id)arg4 storyUserProperties:(id)arg5 storyPlayMode:(long long)arg6 recentUpdateFriendNameList:(id)arg7 viewLocation:(long long)arg8 sortOrderId:(id)arg9 viewingType:(long long)arg10 storiesViewingContext:(unsigned long long)arg11 viewLocationPosition:(unsigned long long)arg12 storyViewingActionContext:(unsigned long long)arg13 playSource:(long long)arg14 miniProfileHandler:(id)arg15 navigationDelegate:(id)arg16 storySessionId:(long long)arg17;
