...
#import "SOJUBroadcastMobsApiDeleteMobStoryRequest.h"

@class NSString;

@interface SOJUBroadcastMobsApiDeleteMobStoryRequest : NSObject <SOJUBroadcastMobsApiDeleteMobStoryRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 idValue:(id)arg4;
- (id)toJson;
- (id)toDictionary;
