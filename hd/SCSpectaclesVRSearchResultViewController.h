...
@interface SCSpectaclesVRSearchResultViewController : SCGalleryMomentClustererViewController
{
    id <SCSpectaclesVRSearchResultViewControllerDelegate> _delegate;
}

@property(nonatomic) __weak id <SCSpectaclesVRSearchResultViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
