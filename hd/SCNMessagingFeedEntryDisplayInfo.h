...
@interface SCNMessagingFeedEntryDisplayInfo : NSObject
{
    ...
    NSArray *_lastSenderUserIds;
    SCNMessagingUUID *_feedItemCreatorId;
    SCNMessagingFeedItem *_feedItem;
}

+ (id)FeedEntryDisplayInfoWithDisplayTimestamp:(long long)arg1 lastUpdateActorUserIds:(id)arg2 lastSenderUserIds:(id)arg3 feedItemCreatorId:(id)arg4 feedItem:(id)arg5 viewed:(_Bool)arg6;
...
@property(readonly, nonatomic) NSArray *lastSenderUserIds; // @synthesize lastSenderUserIds=_lastSenderUserIds;
...
- (void).cxx_destruct;
- (id)description;
- (id)initWithDisplayTimestamp:(long long)arg1 lastUpdateActorUserIds:(id)arg2 lastSenderUserIds:(id)arg3 feedItemCreatorId:(id)arg4 feedItem:(id)arg5 viewed:(_Bool)arg6;
