...
@class SCDiscoverFeedBaseServices, SCDiscoverFeedCognacServices, SCDiscoverFeedStoriesServices, SCLegacySnapchatterServices, SCNetworkImageServices, SCServicesExposer, SCSnapchatterServices, SCStoriesPreferencesServices, SCUserSessionScope, SCUserStorageServices;
