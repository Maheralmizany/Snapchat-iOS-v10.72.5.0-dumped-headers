...
- (void)viewDidLoad;
- (void)loadView;
- (void)_makeScoreVisibilityViewModelWithPlayerItem:(id)arg1 gameSessionId:(id)arg2;
- (void)_makeViewModelsWithSupportDataProvider:(id)arg1 playerItem:(id)arg2 gameSessionId:(id)arg3;
