...
@class FBKVOController, NSMapTable, NSMutableArray, NSMutableDictionary, NSNotificationCenter, NSString, SCExperimentManager, SCOperaConfiguration;
...
- (void)updatePlayerView:(id)arg1 playerConfiguration:(struct SCPlayerConfiguration)arg2;
