...
@class NSString, SCCORECompositeStoryId, SCSSMCardDebugInfo, SCSSMClientDisplayInfo, SCSSMClientRankingFeatures, SCSSMCognacCard, SCSSMJaguarClientLogging, SCSSMLensCategoryCard, SCSSMLensChallengeCard, SCSSMLensChallengeStoryCard, SCSSMLensObjectCard, SCSSMMapTileCard, SCSSMMomentStoryCard, SCSSMOurStoryCard, SCSSMPivotCard, SCSSMPromotedStoryCard, SCSSMPublicUserStoryCard, SCSSMPublisherStoryCard, SCSSMSelectionCard, SCSSMSoloStoryCard, SCSSMStoryCard_TapAction, SCSSMUserStoryCard;
...
@property(retain, nonatomic) SCSSMLensCategoryCard *lensCategoryCard; // @dynamic lensCategoryCard;
