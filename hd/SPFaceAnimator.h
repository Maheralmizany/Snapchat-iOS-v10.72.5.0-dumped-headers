...
@class F2FWarpingProcessor, NSArray, NSDate, NSError, NSNumber, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSProgress, NSString, NSTimer, SPApplicationStateHolder, SPFramesProfiler, SPProcessorsManager, SPScenario, SPSharedQueuesHolder, SPThreadSafeMutableContainer, SPThreadSafeMutableDictionary, SPWarpingBeautificationCache;
...
- (void)start;
- (void)dealloc;
- (id)initWithPersons:(id)arg1 scenario:(id)arg2 consumer:(id)arg3 processingThreads:(unsigned long long)arg4;
