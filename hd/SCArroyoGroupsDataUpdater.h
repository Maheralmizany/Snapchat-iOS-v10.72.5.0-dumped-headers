...
- (id)initWithNativeSessionManager:(id)arg1 lazySnapchattersDataFetcher:(id)arg2 lazySnapchatterUserInfoProvider:(id)arg3 lazySnapchatterPublicInfoFetcher:(id)arg4 arroyoGroupsStorage:(id)arg5 groupsDataTracker:(id)arg6 arroyoConversationIdsManager:(id)arg7;
