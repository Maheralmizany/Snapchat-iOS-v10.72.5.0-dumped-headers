...
@class NSMutableArray, SCSSMSoloStoryMetadata;

@interface SCSSMSoloStoryCard : GPBMessage
{
}
...
@property(retain, nonatomic) SCSSMSoloStoryMetadata *metadata; // @dynamic metadata;
