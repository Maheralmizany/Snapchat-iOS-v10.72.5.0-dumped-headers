...
#import "SCLensGestureViewProvider.h"
#import "SCLensUserInterfaceDelegate.h"
#import "SCTraceEnabled.h"

@class CALayer, NSArray, NSString, NSTimer, SCEffectViewportFragment, SCGrowingButton, SCLongPressAnimationView, SCLongPressGestureRecognizer, SCLongPressParticleAnimationView, SCNavigationBarButtonItem, SCNavigationItemView, SCPreviewTooltipBalloon, UILabel, UIPanGestureRecognizer, UIPinchGestureRecognizer, UISwipeGestureRecognizer, UITapGestureRecognizer, UIView<SCCameraTimer>;
...
@property(retain, nonatomic) UIView *galleryIcon; // @synthesize galleryIcon=_galleryIcon;
- (void).cxx_destruct;
...
- (struct CGRect)defaultCameraTimerFrame;
