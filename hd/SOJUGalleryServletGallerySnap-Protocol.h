...
@property(readonly, copy, nonatomic) NSString *spectaclesSecondaryMetadataRedirectUri;
@property(readonly, copy, nonatomic) NSNumber *hasSpectaclesSecondaryMetadata;
@property(readonly, copy, nonatomic) NSString *spectaclesSecondaryMetadataUrl;
