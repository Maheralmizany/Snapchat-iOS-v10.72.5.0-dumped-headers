...
- (void)_handleRequestSuccessWithResponse:(id)arg1 originQueryForResponse:(id)arg2 query:(id)arg3 isResponseUpToDate:(_Bool)arg4 isRefreshing:(_Bool)arg5 requestType:(long long)arg6 updatingBlock:(CDUnknownBlockType)arg7;
...
- (void)_handleResponse:(id)arg1 responseQuery:(id)arg2 query:(id)arg3 isResponseUpToDate:(_Bool)arg4 isRefreshing:(_Bool)arg5 isCachedResponse:(_Bool)arg6 requestType:(long long)arg7 updatingBlock:(CDUnknownBlockType)arg8;
