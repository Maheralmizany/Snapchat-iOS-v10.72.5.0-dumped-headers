...
#import "SCVideoCaptureConfiguration.h"
...
- (id)initWithRecordingMethod:(unsigned long long)arg1 captureSessionId:(id)arg2 activeLensId:(id)arg3 lensEnabled:(_Bool)arg4 isSnappable:(_Bool)arg5 isSnapWithDepth:(_Bool)arg6 isStoppingRecording:(_Bool)arg7 lensInitiatedCapture:(_Bool)arg8 batchCaptureActive:(_Bool)arg9;
