...
@class GPBInt64ObjectDictionary, SCULRequestInfo;

@interface SCULScheduleLensRequest : GPBMessage
{
}
...
@property(retain, nonatomic) GPBInt64ObjectDictionary *rearChecksums; // @dynamic rearChecksums;
@property(readonly, nonatomic) unsigned long long rearChecksums_Count; // @dynamic rearChecksums_Count;
