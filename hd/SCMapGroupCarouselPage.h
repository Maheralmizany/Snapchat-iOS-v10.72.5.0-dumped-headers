...
#import "SCMapCarouselGroupRowControllerDelegate.h"
#import "SCMapCarouselPage.h"
#import "SCMapCarouselPersonRowControllerDelegate.h"

@class NSArray, NSString, SCExperimentManager, SCLazy, SCMapCarouselPageView, SCMapStatusStore, SCMapUserPreferences, UIView;
...
- (id)initWithCurrentUserId:(id)arg1 delegate:(id)arg2 experimentManager:(id)arg3 group:(id)arg4 imageDownloader:(id)arg5 mapPeopleFriendsProvider:(id)arg6 mapPeopleGroupsProvider:(id)arg7 mapPersonLocationsProvider:(id)arg8 mapSessionId:(unsigned long long)arg9 mapStatusStore:(id)arg10 mapUserPreferences:(id)arg11 sharingPreferencesProvider:(id)arg12;
