...
@class NSString, SCDiscoverFeedCollectionViewCellTapHandler, SCDiscoverFeedWhiteSpaceHeadlineWithSubtitleView, SCDiscoverFeedWhiteSpaceImageWithTextView, SCDiscoverFeedWhiteSpaceProfileRowView, SCEventListenerAnnouncer, SCLazy, UIView;

@interface SCDiscoverFeedWhiteSpacePublicUserStoryCarouselCell : SCSearchCollectionViewCell <UIGestureRecognizerDelegate, SCEventAnnouncing, SCEventListener, SCViewModelConfigurable, SCActionable, SCViewportConfigurable, SCDiscoverFeedStoryTileWithCoverImageConfigurable, SCDiscoverFeedCollectionViewCellAnimating, SCDiscoverFeedTileOperaBaseViewProviding, SCDiscoverFeedWhiteSpaceTileGestureHandling>
{
    ...
    SCDiscoverFeedWhiteSpaceHeadlineWithSubtitleView *_headlineView;
