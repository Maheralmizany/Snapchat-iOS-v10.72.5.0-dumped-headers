...
- (void)_setupAudioPlayer:(id)arg1 time:(double)arg2 error:(id)arg3;
- (void)_setupAudioPlayerWithAudioURL:(id)arg1 time:(double)arg2;
- (void)_setupAudioPlayerWithAudioData:(id)arg1 time:(double)arg2;
