...
@interface SCGifSendingServicesEntryPoint : SCEntryPoint
{
    ...
    SCServicesExposer *_gifSendingServicesExposer;
}

@property(retain, nonatomic) SCServicesExposer *gifSendingServicesExposer; // @synthesize gifSendingServicesExposer=_gifSendingServicesExposer;
...
- (void).cxx_destruct;
- (void)begin;
- (id)_initializeGifSenderWithMediaPreparer:(id)arg1;
