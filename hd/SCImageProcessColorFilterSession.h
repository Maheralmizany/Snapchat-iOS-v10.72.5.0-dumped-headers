...
@class CADisplayLink, NSArray, NSData, NSObject<OS_dispatch_semaphore>, NSString, SCImageProcessColorFilterSessionListenerAnnouncer, SCImageProcessCommand, SCImageProcessPlaybackRenderer, SCImageProcessQueue, SCQueuePerformer, UIImage;
