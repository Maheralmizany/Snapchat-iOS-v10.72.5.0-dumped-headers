...
- (id)extraPagePropertiesForAdRequestClientId:(id)arg1 experimentManager:(id)arg2 adProduectType:(unsigned long long)arg3 skippableType:(long long)arg4 unskippableDurationMs:(double)arg5 progressBarEnabled:(_Bool)arg6;
