...
@class NSMutableArray, NSString, SCMapExploreItem, SCMapServerService, SCMapStatusStore, SCXBitmojiSpriteTextureBinder, SCXFloorSpriteTextureBinder, SCXRenderLayer, SCXRenderLayerOptions, SCXSpriteWidthInterpolatorProvider, UIView<SCMapInstance>;

@interface SCExploreMapView : UIView <SCMapLoadingStateListener>
{
