...
#import "SCMiniProfileFriendCollectionViewCellDelegate.h"
#import "SCSnapchattersDataRequestListener.h"

@class Friend, NSString, SCEventListenerAnnouncer, SCLazy, SCMiniProfileFriendCollectionViewCell, SCOperaPresenter, SCUserSession, UIViewController<SCPageNameLogging>;
