...
@class NSDictionary, NSString, SCLensExplorerSectionHeaderViewModel;

@interface SCLensExplorerSupplementaryViewProvider : NSObject <SCCollectionViewSectionSupplementaryViewProviding, SCCollectionViewSupplementaryViewModelsConfigurable, SCActionable>
{
    SCLensExplorerSectionHeaderViewModel *_viewModel;
...
+ (id)lensExplorerSupplementaryViewWithSectionIdentifier:(id)arg1 actionHandler:(id)arg2;
...
- (id)initWithViewModel:(id)arg1 actionHandler:(id)arg2;
