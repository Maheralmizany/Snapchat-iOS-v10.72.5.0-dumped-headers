...
+ (id)_remoteWebPageProperties:(id)arg1 bottomSnap:(id)arg2 pageProperties:(id)arg3 adKey:(id)arg4 adId:(id)arg5 isSharable:(_Bool)arg6 isVideoBoxEnabled:(_Bool)arg7 userSession:(id)arg8;
+ (id)_topSnapPageProperties:(id)arg1 contentDeliveryMedia:(id)arg2 mediaManager:(id)arg3 pageProperties:(id)arg4 adId:(id)arg5 adKey:(id)arg6 adBrandName:(id)arg7 adHeadline:(id)arg8 isAdContentLooping:(_Bool)arg9 userSession:(id)arg10 streamingURLProvider:(id)arg11;
