...
- (id)initWithUserSession:(id)arg1 storiesDataCoordinatorLazy:(id)arg2 storiesPlaybackDataProviderLazy:(id)arg3 storiesSyncNetworkRequesterLazy:(id)arg4 queuePerformer:(id)arg5;
