...
- (void)removeCountDownTimerForAllSnapsInConvo:(id)arg1 enforceMessageExists:(_Bool)arg2 cellViewPosition:(long long)arg3;
- (void)removeCountDownTimerForSnap:(id)arg1 conversationId:(id)arg2 enforceMessageExists:(_Bool)arg3 cellViewPosition:(long long)arg4;
