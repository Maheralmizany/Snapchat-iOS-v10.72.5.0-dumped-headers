...
@class NSMutableArray, SCSSMOurStoryMetadata, SCSSMStoryFragmentMetadata, SCSSMStoryPrefetchMetadata;

@interface SCSSMOurStoryCard : GPBMessage
{
}
...
@property(retain, nonatomic) SCSSMOurStoryMetadata *metadata; // @dynamic metadata;
