...
@class NSDictionary, NSString, PreviewViewController, SCBaseUploadableChatMedia, SCDiscoverMediaBlob, SCDiscoverMediaMessagePrepper, SCPreviewConfiguration, SCSendToTransitionProvider, SCUpdateListenerAnnouncer, SCUserSession, UIViewController, UIViewController<SCSendToScreen>;
