...
@class NSArray, NSMutableArray, NSString, SCStackedMediaFlowLayout, UICollectionView<SCActionMenuRenderableCellContentView>, UIView, UIViewController<SCChatCellMessageStateUpdateDelegate>, UIViewController<SCMediaFullScreenViewDelegate><SCChatCellMessageStateUpdateDelegate><SCPageNameLogging>;
