...
@class GPBMessage, NSData, NSNumber, NSOutputStream, NSString;
...
struct ComplexEffect {
    ...
    struct Rect<float> _field21;
    struct Rect<float> _field22;
    int _field23;
    _Bool _field24;
    _Bool _field25;
    _Bool _field26;
...
struct GamePresenceService;

struct GamePresenceServiceDelegate;
...
struct Handle<std::__1::shared_ptr<talkcorev3::GamePresenceService>, std::__1::shared_ptr<talkcorev3::GamePresenceService>> {
    struct shared_ptr<djinni::ProxyCache<djinni::CppProxyCacheTraits>::Pimpl> m_cache;
    shared_ptr_b09b456c m_obj;
};

struct Handle<std::__1::shared_ptr<talkcorev3::GamePresenceServiceDelegate>, std::__1::shared_ptr<talkcorev3::GamePresenceServiceDelegate>> {
    struct shared_ptr<djinni::ProxyCache<djinni::CppProxyCacheTraits>::Pimpl> m_cache;
    shared_ptr_a34b3ce0 m_obj;
};
...
struct ImageProcessingConfig {
    ...
    struct array<int, 2> _field7;
    struct array<glm::tmat3x3<float, glm::packed_highp>, 2> _field8;
    ...
    int _field13;
    _Bool _field14;
    struct array<glm::tmat4x4<float, glm::packed_highp>, 2> _field15;
    struct tmat3x3<float, glm::packed_highp> _field16;
};
...
struct MouthCalibration {
    struct vector<std::__1::vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>>, std::__1::allocator<std::__1::vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>>>> warpingData;
    _Bool corrupted;
};
...
struct Rect<float> {
    struct LSPoint<float> _field1;
    struct Size<float> _field2;
};
...
struct ViewNode {
    ...
    struct SmallShared<Composer::ViewNodeAttributesApplier> _field7;
    ...
    struct unique_ptr<Composer::CSSAttributesManager, std::__1::default_delete<Composer::CSSAttributesManager>> _field12;
    int _field13;
    int _field14;
    int _field15;
    int _field16;
    int _field17;
    struct bitset<26> _field18;
    struct static_vector<Composer::ShadowNode *, 2, void> _field19;
    struct View _field20;
    struct SmallShared<Composer::ValueFunction> _field21;
    struct SmallShared<Composer::ValueFunction> _field22;
    struct SmallShared<Composer::ValueFunction> _field23;
...
struct array<glm::tmat3x3<float, glm::packed_highp>, 2> {
    struct tmat3x3<float, glm::packed_highp> _field1[2];
};

struct array<glm::tmat4x4<float, glm::packed_highp>, 2> {
    struct tmat4x4<float, glm::packed_highp> _field1[2];
};
...
struct shared_ptr<TargetSegmentationResult> {
    struct TargetSegmentationResult *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
...
struct shared_ptr<talkcorev3::GamePresenceService> {
    struct GamePresenceService *__ptr_;
    struct __shared_weak_count *__cntrl_;
};

struct shared_ptr<talkcorev3::GamePresenceServiceDelegate> {
    struct GamePresenceServiceDelegate *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
...
struct shared_ptr<video_effects::Renderer> {
    struct Renderer *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
...
struct tmat4x4<float, glm::packed_highp> {
    struct tvec4<float, glm::packed_highp> _field1[4];
};
...
struct unique_ptr<Composer::CSSAttributesManager, std::__1::default_delete<Composer::CSSAttributesManager>> {
    struct __compressed_pair<Composer::CSSAttributesManager *, std::__1::default_delete<Composer::CSSAttributesManager>> {
...
struct vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>>;
...
struct vector<std::__1::vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>>, std::__1::allocator<std::__1::vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>>>> {
    struct vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>> *__begin_;
    struct vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>> *__end_;
    struct __compressed_pair<std::__1::vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>>*, std::__1::allocator<std::__1::vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>>>> {
        struct vector<description::render::MouthCalibration::Data, std::__1::allocator<description::render::MouthCalibration::Data>> *__value_;
    } __end_cap_;
};
...
struct vector<std::__1::vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>>, std::__1::allocator<std::__1::vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>>>> {
    struct vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>> *__begin_;
    struct vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>> *__end_;
    struct __compressed_pair<std::__1::vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>>*, std::__1::allocator<std::__1::vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>>>> {
        struct vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>> *__value_;
    } __end_cap_;
};
...
struct vector<warping::MouthInsertionCalibrationData, std::__1::allocator<warping::MouthInsertionCalibrationData>>;
...
typedef struct shared_ptr<TargetSegmentationResult> {
    struct TargetSegmentationResult *__ptr_;
    struct __shared_weak_count *__cntrl_;
} shared_ptr_b21ca52b;
...
typedef struct shared_ptr<talkcorev3::GamePresenceService> {
    struct GamePresenceService *__ptr_;
    struct __shared_weak_count *__cntrl_;
} shared_ptr_b09b456c;

typedef struct shared_ptr<talkcorev3::GamePresenceServiceDelegate> {
    struct GamePresenceServiceDelegate *__ptr_;
    struct __shared_weak_count *__cntrl_;
} shared_ptr_a34b3ce0;
