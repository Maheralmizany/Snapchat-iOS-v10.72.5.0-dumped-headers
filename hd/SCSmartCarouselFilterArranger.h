...
@class NSMutableArray, NSMutableDictionary, SCExperimentManager, SCFilterCarouselLoggingParameters, SCSmartCarouselStackingManager, SCSmartCarouselSwipeOrder;
...
- (id)commandConfigurationsForCurrentFiltersWithMediaCommands;
