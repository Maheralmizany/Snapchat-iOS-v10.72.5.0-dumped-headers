...
+ (id)constructUnSymbolicatedFrameWithObjAddr:(unsigned long long)arg1 pc:(unsigned long long)arg2;
+ (id)constructPreambleWithTraceNum:(int)arg1 objName:(const char *)arg2 pc:(unsigned long long)arg3;
...
- (id)stringWithHandledExceptionName:(id)arg1 reason:(id)arg2;
