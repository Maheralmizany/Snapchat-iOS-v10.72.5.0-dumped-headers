...
#import "SCChatV3ConversationFetcherHandler.h"
...
- (void)dealloc;
- (id)initWithConversationFetcher:(id)arg1 withConversationStore:(id)arg2 messageSender:(id)arg3 withMessageStateHandler:(id)arg4 feedUpdater:(id)arg5 withMessageActionHandler:(id)arg6 arroyoConversationIdsManager:(id)arg7 withExperimentManager:(id)arg8 withGroupManager:(id)arg9 withSnapchattersDataMutator:(id)arg10 withUserHelper:(id)arg11 snapLogger:(id)arg12 fideliusHelper:(id)arg13 username:(id)arg14 chatLogger:(id)arg15 pinnedConversationsDataCoordinator:(id)arg16 batchFetcher:(id)arg17 receiveFlowLogger:(id)arg18 autoShakeToReporter:(id)arg19;
