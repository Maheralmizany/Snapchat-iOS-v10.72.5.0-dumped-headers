...
@class NSArray, NSDictionary, NSMutableArray, NSObject<NSCopying>, NSString, SCEventListenerAnnouncer, SCSendToDocObjectRecipientDataSource, SCSendToLatencyMetricLogger, SCSendToRecipientViewModel, SCUserSession;
...
- (void).cxx_destruct;
- (id)_sortedFirstSnapSectionIfNeeded:(id)arg1;
