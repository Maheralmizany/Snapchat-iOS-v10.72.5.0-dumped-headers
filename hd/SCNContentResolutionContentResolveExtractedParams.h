...
+ (id)ContentResolveExtractedParamsWithContentId:(id)arg1 isFastStartEnabled:(id)arg2 isOriginalUrl:(_Bool)arg3 originalUrlReason:(long long)arg4 isBoltFallbackServiceUrl:(_Bool)arg5 boltFallbackServiceUrlReason:(long long)arg6 wasSecondaryUrlAvailable:(_Bool)arg7 resolveTime:(id)arg8 variantSelected:(id)arg9 availableVariants:(id)arg10;
...
- (void).cxx_destruct;
- (id)description;
- (id)initWithContentId:(id)arg1 isFastStartEnabled:(id)arg2 isOriginalUrl:(_Bool)arg3 originalUrlReason:(long long)arg4 isBoltFallbackServiceUrl:(_Bool)arg5 boltFallbackServiceUrlReason:(long long)arg6 wasSecondaryUrlAvailable:(_Bool)arg7 resolveTime:(id)arg8 variantSelected:(id)arg9 availableVariants:(id)arg10;
