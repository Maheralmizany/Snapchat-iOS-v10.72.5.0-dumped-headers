...
#import "SCTV3ChatServices.h"
#import "SCTV3TooltipServicesDelegate.h"

@class NSString, SCChatInputViewController, SCTV3ELMContainerView, SCTV3TooltipServices, SCTalkV3Manager, UIView;
