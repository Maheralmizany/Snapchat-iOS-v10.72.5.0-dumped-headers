...
#import "SCPreferencesObservationContextDelegate.h"

@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, SCDocObjectContext, SCPreferencesObservationGraph, SCSQLitePreferencesFetcher;

@interface SCDocPreferences : SCPreferences <SCPreferencesObservationContextDelegate>
{
...
- (void).cxx_destruct;
- (id)_SQLiteFetcher;
- (void)_cleanUpSQLiteFiles;
- (void)_setProtectionForSQLiteFiles;
...
- (void)invalidate;
- (id)initWithSQLiteFilePath:(id)arg1 docObjectContext:(id)arg2;
