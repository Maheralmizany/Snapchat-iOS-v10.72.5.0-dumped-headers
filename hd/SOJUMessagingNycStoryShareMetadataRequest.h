...
#import "SOJUMessagingNycStoryShareMetadataRequest.h"

@class NSString;

@interface SOJUMessagingNycStoryShareMetadataRequest : NSObject <SOJUMessagingNycStoryShareMetadataRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
