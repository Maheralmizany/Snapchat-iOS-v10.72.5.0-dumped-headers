...
#import "SCBloopsPickerController.h"

@class NSString, SCStickerPickerMenuView, UIView, UIView<SCBloopsPickerView>;
...
- (void).cxx_destruct;
- (void)openBloopsSuperCategoryIfAvailable;
- (void)openBloopsSuperCategoryIfNeeded;
