...
#import "SCCaptionLogger.h"
#import "SCStickerContainerLogger.h"
...
+ (void)logSnapSaveEvents:(SCSnapCommonLoggingParameters *)arg1 snapIdInSnapchatGallery:(NSString *)arg2 mediaIdInSnapchatGallery:(NSString *)arg3 entryIdInSnapchatGallery:(NSString *)arg4 savingSessionId:(NSString *)arg5 saveToCameraRoll:(_Bool)arg6 manualSave:(_Bool)arg7;
