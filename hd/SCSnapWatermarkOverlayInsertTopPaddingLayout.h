...
@interface SCSnapWatermarkOverlayInsertTopPaddingLayout : NSObject <SCSnapWatermarkOverlayLayout>
{
    id <SCSnapWatermarkOverlayLayout> _decoratedLayout;
    double _topPaddingOffset;
}
