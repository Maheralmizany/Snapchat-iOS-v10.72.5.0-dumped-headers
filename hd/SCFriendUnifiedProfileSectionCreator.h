...
@class NSString, SCArroyoConversationIdsManager, SCCharmsBlizzardLogger, SCCharmsDataCoordinator, SCCharmsViewingDataCoordinator, SCEventListenerAnnouncer, SCFriendProfilePageActionHandler, SCFriendUnifiedProfileDataSource, SCFriendUnifiedProfilePromptSectionDataCoordinator, SCLazy, SCObservable, SCProfileChatAttachmentDataStore, SCProfileChatMediaDataSource, SCUnifiedProfileViewLayoutConfiguration, SCUserSession, UIViewController;
