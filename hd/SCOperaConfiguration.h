...
@interface SCOperaConfiguration : NSObject
{
    ...
    _Bool _enablePlayerPreferredForwardBufferDuration;
    ...
    unsigned long long _subtitlesAvailability;
    double _subtitlesVerticalPositionPercentage;
    double _subtitlesVolumeThreshold;
    ...
    id <SCContextOperaOverlayProvider> _contextMenuProvider;
    ...
    long long _startupPreferredForwardBufferDurationMs;
    long long _postStartupPreferredForwardBufferDurationMs;
...
@property(readonly, nonatomic) long long postStartupPreferredForwardBufferDurationMs; // @synthesize postStartupPreferredForwardBufferDurationMs=_postStartupPreferredForwardBufferDurationMs;
@property(readonly, nonatomic) long long startupPreferredForwardBufferDurationMs; // @synthesize startupPreferredForwardBufferDurationMs=_startupPreferredForwardBufferDurationMs;
@property(readonly, nonatomic) _Bool enablePlayerPreferredForwardBufferDuration; // @synthesize enablePlayerPreferredForwardBufferDuration=_enablePlayerPreferredForwardBufferDuration;
...
@property(retain, nonatomic) id <SCContextOperaOverlayProvider> contextMenuProvider; // @synthesize contextMenuProvider=_contextMenuProvider;
...
@property(nonatomic) double subtitlesVolumeThreshold; // @synthesize subtitlesVolumeThreshold=_subtitlesVolumeThreshold;
@property(nonatomic) double subtitlesVerticalPositionPercentage; // @synthesize subtitlesVerticalPositionPercentage=_subtitlesVerticalPositionPercentage;
@property(nonatomic) unsigned long long subtitlesAvailability; // @synthesize subtitlesAvailability=_subtitlesAvailability;
