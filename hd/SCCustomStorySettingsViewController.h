...
#import "SCCustomStorySettingsStoryCellDelegate.h"
#import "SCCustomStorySettingsStoryHeaderCellDelegate.h"
#import "SCDataCoordinatorListener.h"
#import "SCExportMyStoriesManagerDelegate.h"
#import "SCGroupStoryGeofencePrivacyCellDelegate.h"
#import "SCGroupStorySelectMembersViewControllerDelegate.h"
#import "SCGroupStorySettingsControllerDelegate.h"
...
@interface SCCustomStorySettingsViewController : SCGenericSettingsViewController <SCExportMyStoriesManagerDelegate, SCLocationObserver, SCCustomStorySettingsStoryHeaderCellDelegate, SCGroupStorySettingsControllerDelegate, SCCustomStorySettingsStoryCellDelegate, SCOperaPresenterDelegate, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, SCSendToNavigationDelegate, SCGroupStorySelectMembersViewControllerDelegate, SCGroupStoryGeofencePrivacyCellDelegate, SCDataCoordinatorListener, SCPageNameLogging, SCStoriesModelUpdateListener>
{
...
- (void)_updateCreationSessionWithPublicationId:(id)arg1;
...
- (id)initWithCreationContext:(long long)arg1 userSession:(id)arg2 creationSettings:(id)arg3 fromViewController:(id)arg4 createType:(long long)arg5 creationSession:(id)arg6 customStoriesDataFetcher:(id)arg7 customStoriesDataMutator:(id)arg8;
