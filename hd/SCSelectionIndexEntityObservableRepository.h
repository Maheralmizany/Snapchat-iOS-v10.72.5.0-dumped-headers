...
#import "SIGIndexEntityObservableRepository.h"
...
- (void).cxx_destruct;
- (void)warmUp;
- (id)entityCountObservableForPredefinedKey:(id)arg1;
@property(readonly, nonatomic) SCObservable *sortedEntitiesObservable;
- (id)initWithSortableSnapchatterObservableRepository:(id)arg1 selectionGroupObservableRepository:(id)arg2;
