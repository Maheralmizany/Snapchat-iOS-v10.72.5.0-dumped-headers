...
@class NSString, SCActionModel, SCDiscoverFeedDebugViewModel, SCDiscoverFeedStoryLoggingInfo, SCDiscoverFeedWhiteSpaceDynamicPostViewLayerViewModel, SCDiscoverFeedWhiteSpaceHeadlineWithSubtitleViewModel, SCDiscoverFeedWhiteSpaceImageWithTextViewModel, SCDiscoverFeedWhiteSpaceProfileRowViewModel, SCDiscoverFeedWhiteSpaceSubscriptionIconViewModel, UIColor;

@interface SCDiscoverFeedWhiteSpacePublicUserStoryCarouselCellViewModel : NSObject <NSCopying>
{
    SCDiscoverFeedWhiteSpaceImageWithTextViewModel *_imageWithTextViewModel;
    SCDiscoverFeedWhiteSpaceHeadlineWithSubtitleViewModel *_headlineViewModel;
...
@property(readonly, copy, nonatomic) SCDiscoverFeedWhiteSpaceHeadlineWithSubtitleViewModel *headlineViewModel; // @synthesize headlineViewModel=_headlineViewModel;
