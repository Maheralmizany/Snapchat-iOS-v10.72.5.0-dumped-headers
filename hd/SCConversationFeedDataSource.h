...
@class NSArray, NSDictionary, NSObject<NSCopying>, NSString, SCCheetahFeedDebugManager, SCFeedItemStateUpdater, SCFriendsFeedHapticsFeedbackRuleEvaluator, SCFriendsFeedSnapReplayAnimationStateManager, SCFriendsFeedSubstituteAnimationStateManager, SCFriendsFeedViewModelCoordinator, SCScopedAccess, SCStoriesReplayManager, SCUserSession;
