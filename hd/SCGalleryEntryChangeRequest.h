...
@property(nonatomic) int titleOverlayUrlType;
@property(copy, nonatomic) NSString *titleOverlayUrl;
@property(copy, nonatomic) NSString *title;
@property(nonatomic) int thumbnailUrlType;
@property(copy, nonatomic) NSString *thumbnailUrl;
@property(nonatomic) _Bool thumbnailEncrypted;
