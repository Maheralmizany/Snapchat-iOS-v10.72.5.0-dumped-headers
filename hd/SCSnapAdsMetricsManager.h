...
#import "SCSnapAdsAdRenderDataParserMetricsAdapter.h"
#import "SCSnapAdsOperationMetricsAdapter.h"
...
- (void).cxx_destruct;
- (void)_requestSubmittedAdIdentifiers:(id)arg1 requestType:(unsigned long long)arg2 requestURL:(id)arg3 targetingParams:(id)arg4 debugViewParams:(id)arg5 isPrimary:(_Bool)arg6;
...
- (void)serveResponseReceived:(id)arg1 isPrimary:(_Bool)arg2;
