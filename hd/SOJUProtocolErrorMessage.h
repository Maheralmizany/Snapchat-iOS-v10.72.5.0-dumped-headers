...
#import "SOJUProtocolErrorMessage.h"

@class NSString;

@interface SOJUProtocolErrorMessage : NSObject <SOJUProtocolErrorMessage>
{
    NSString *_type;
    NSString *_idValue;
...
- (id)initWithType:(id)arg1 idValue:(id)arg2 appEngineTarget:(id)arg3 message:(id)arg4;
- (id)toJson;
- (id)toDictionary;
