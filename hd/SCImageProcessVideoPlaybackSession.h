...
@class AVAsset, AVAudioMix, AVMutableComposition, AVMutableCompositionTrack, AVPlayer, AVPlayerItem, AVPlayerItemVideoOutput, CADisplayLink, FBKVOController, NSArray, NSDictionary, NSObject<OS_dispatch_semaphore>, NSString, SCImageProcessCommand, SCImageProcessPlaybackRenderer, SCImageProcessQueue, SCImageProcessVideoPlaybackRequest, SCImageProcessVideoPlaybackSessionListenerAnnouncer;
...
- (void)prepareToPlay;
- (void)dealloc;
- (id)initWithQueue:(id)arg1 player:(id)arg2 asset:(id)arg3 layer:(id)arg4 orientation:(long long)arg5 outputCommands:(id)arg6 midOutputCommands:(id)arg7 useHighFrameRate:(_Bool)arg8 isPlaybackBufferMonitoringEnabled:(_Bool)arg9 useSeparateAudioPlayer:(_Bool)arg10 videoInfoForLogging:(id)arg11;
