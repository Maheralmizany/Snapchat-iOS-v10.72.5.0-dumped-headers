...
- (_Bool)isUnifiedCameraObjectExportable;
- (_Bool)isColorFilter;
- (_Bool)isUnifiedCameraObjectCompatible;
- (_Bool)isGPUPass;
- (_Bool)loadWithContext:(id)arg1 error:(id *)arg2;
- (id)initWithLens:(id)arg1 isVideo:(_Bool)arg2 isColorFilter:(_Bool)arg3 isUcoExportable:(_Bool)arg4 metadata:(id)arg5;
