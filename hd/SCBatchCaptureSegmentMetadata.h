...
#import "SCBatchCaptureSegmentMetadata.h"
...
- (id)initWithMediaOrientation:(long long)arg1 createTime:(id)arg2 captureTime:(id)arg3 location:(id)arg4 fromFrontFacingCamera:(_Bool)arg5 lensesActive:(_Bool)arg6;
