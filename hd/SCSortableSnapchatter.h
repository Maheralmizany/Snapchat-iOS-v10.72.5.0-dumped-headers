...
- (id)initWithSnapchatter:(id)arg1 nameToDisplay:(id)arg2 sortingKey:(id)arg3 sanitizedString:(id)arg4;
- (id)initWithSnapchatter:(id)arg1 displayMetadata:(id)arg2;
