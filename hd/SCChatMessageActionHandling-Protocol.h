...
@class NSArray, NSAttributedString, NSData, NSDate, NSDictionary, NSNumber, NSObject<OS_dispatch_queue>, NSSet, NSString, SCChatDraft, SCChatMediaContent, SCChatMediaContentMetadata, SCChatMessageContentContainer, SCChatMessageParticipantIdentifier, SCChatMetricsEventInfo, SCChatReplyMediaProperties, SCRequest, SOJUSticker;
...
- (void)conversationId:(NSString *)arg1 finishViewingSnap:(NSString *)arg2 enforceMessageExists:(_Bool)arg3 cellViewPosition:(long long)arg4;
- (void)conversationId:(NSString *)arg1 finishViewingSnap:(NSString *)arg2 cellViewPosition:(long long)arg3;
