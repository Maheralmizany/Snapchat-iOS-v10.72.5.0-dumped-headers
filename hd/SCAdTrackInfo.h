...
@interface SCAdTrackInfo : NSObject <NSCopying>
{
    ...
    double _unskippableDurationMillis;
    struct CGSize _tileSize;
    struct CGSize _screenSize;
}

@property(readonly, nonatomic) double unskippableDurationMillis; // @synthesize unskippableDurationMillis=_unskippableDurationMillis;
...
- (id)initWithAdType:(long long)arg1 isUnskippableAd:(_Bool)arg2 viewContext:(id)arg3 singleSnapTrackInfo:(id)arg4 storyAdTrackInfo:(id)arg5 adReportTrackInfo:(id)arg6 tileSize:(struct CGSize)arg7 screenSize:(struct CGSize)arg8 unskippableDurationMillis:(double)arg9;
