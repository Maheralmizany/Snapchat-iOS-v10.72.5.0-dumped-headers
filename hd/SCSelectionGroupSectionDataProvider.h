...
@interface SCSelectionGroupSectionDataProvider : NSObject <SCSectionDataProviding>
{
...
- (id)_containerCellViewModelForSelectionGroup:(id)arg1 index:(unsigned long long)arg2 isSelected:(_Bool)arg3 count:(unsigned long long)arg4;
- (void)_setItemToSelectionStateMap:(struct NSDictionary *)arg1;
- (void)_setSelectionGroups:(id)arg1;
