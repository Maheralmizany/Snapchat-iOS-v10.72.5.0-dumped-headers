...
@class AVAssetReader, AVAssetReaderOutput, AVAssetWriter, AVAssetWriterInput, NSArray, NSObject<OS_dispatch_queue>, NSString, SCImageProcessAssetWriterInputPixelBufferAdaptor, SCImageProcessQueue;
