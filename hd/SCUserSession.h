...
- (id)unifiedCameraObjectDataFetcherWithFromGallery:(_Bool)arg1;
- (id)ucoDependencyFactoryWithFromGallery:(_Bool)arg1;
- (id)ucoGenericInMemoryStoreForGallery;
...
@property(readonly, nonatomic) SCUploadURLBufferFactory *uploadURLBufferFactory;
