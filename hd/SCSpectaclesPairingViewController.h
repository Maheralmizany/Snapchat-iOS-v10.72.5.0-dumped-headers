...
#import "SCSpectaclesDeviceNameEditingViewDelegate.h"
#import "SCSpectaclesEventListener.h"
#import "SCSpectaclesUrlViewControllerDelegate.h"
#import "SCTraceEnabled.h"
#import "TTTAttributedLabelDelegate.h"

@class NSDate, NSString, NSTimer, NSUUID, SCButton, SCLoadingIndicatorView, SCSpectaclesActivateDeviceFlow, SCSpectaclesDeviceNameEditingView, SCSpectaclesManager, SCSpectaclesPairingDeviceInformation, Sound, TTTAttributedLabel, UIButton, UIImageView, UILabel, UIPanGestureRecognizer, YYAnimatedImageView;
...
@interface SCSpectaclesPairingViewController : UIViewController <SCTraceEnabled, SCSpectaclesEventListener, TTTAttributedLabelDelegate, SCSpectaclesUrlViewControllerDelegate, SCSpectaclesDeviceNameEditingViewDelegate>
{
    ...
    _Bool _showBTPickerSpinner;
    long long _delayBeforeTitleChange;
...
- (void)changeBTPickerTitleTimeout;
...
- (void)_initSpinner;
- (void)loadView;
- (id)initWithDisplayName:(id)arg1 spectaclesManager:(id)arg2 activateDeviceFlow:(id)arg3 tooltipProvider:(id)arg4 assetProvider:(id)arg5 urlViewControllerFactory:(id)arg6 analyticsLogger:(id)arg7 delegate:(id)arg8 source:(unsigned long long)arg9 showBTPickerSpinner:(_Bool)arg10 delayBeforeTitleChange:(long long)arg11;
