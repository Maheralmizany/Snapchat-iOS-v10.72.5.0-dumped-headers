...
@class NSString, SCOperaPresenter, SCUserSession, SCXRenderLayer, SCXRenderLock, UIViewController<SCPageNameLogging>;
...
- (void)_presentStoryWithPlayableDataModel:(id)arg1 mapStoriesInfo:(id)arg2 storiesPlaybackDataProvider:(id)arg3 storiesMediaCoordinator:(id)arg4 storyManagementPlugin:(id)arg5 baseView:(id)arg6 viewType:(long long)arg7;
- (void)presentStoryWithSummaryInfo:(id)arg1 fromBaseView:(id)arg2 mapStoriesInfo:(id)arg3 storiesPlaybackDataProvider:(id)arg4 storiesMediaCoordinator:(id)arg5;
- (void)presentLegacyMyStories:(id)arg1 fromBaseView:(id)arg2 mapStoriesInfo:(id)arg3 legacyStoriesPlaybackDataProvider:(id)arg4 storiesMediaCoordinator:(id)arg5;
