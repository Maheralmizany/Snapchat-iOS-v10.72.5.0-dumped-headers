...
- (void)setStoryInviteIDHash:(id)arg1;
...
- (void)setMagicMomentTriedCount:(double)arg1;
- (void)setMagicMomentSliderPosition:(double)arg1;
- (void)setMagicMomentApplied:(_Bool)arg1;
