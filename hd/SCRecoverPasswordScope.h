...
@interface SCRecoverPasswordScope : NSObject
{
...
@property(readonly, nonatomic) id <SCRecoverPasswordDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (id)initWithDelegate:(id)arg1 uiContainer:(id)arg2 usernameOrEmail:(id)arg3;
