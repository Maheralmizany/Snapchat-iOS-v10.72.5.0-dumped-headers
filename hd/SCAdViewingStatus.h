...
- (void)setLoadedOnEntry:(_Bool)arg1 loadedOnExit:(_Bool)arg2 visiblePageLoadTimeSeconds:(double)arg3 halfOpenViewedSeconds:(double)arg4 snapIndex:(long long)arg5 interactionZoneItemIndex:(id)arg6 initialPageStatusCode:(id)arg7;
...
- (void)swipedToVideoBoxHalfOpenWithSnapIndex:(long long)arg1;
...
- (void)adShowAtSnapIndex:(long long)arg1 onTopSnap:(_Bool)arg2 onBottomSnap:(_Bool)arg3 currentMediaVolumePercent:(double)arg4 isUnSkippableAd:(_Bool)arg5;
