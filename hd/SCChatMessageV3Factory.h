...
+ (id)updateSnapStateAfterFinishViewingSnap:(id)arg1 playbackState:(long long)arg2 viewerUsername:(id)arg3 autoShakeToReporter:(id)arg4;
+ (id)updatePlaybackStateAfterFinishViewingForSnap:(id)arg1 viewerUsername:(id)arg2;
