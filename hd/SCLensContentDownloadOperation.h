...
- (id)initWithLens:(id)arg1 requestTiming:(long long)arg2 contentDataFetcher:(id)arg3 signatureValidator:(id)arg4 lensPreferences:(id)arg5 lensDownloadLogger:(id)arg6 userInitiated:(_Bool)arg7;
