...
#import "SCStorySnapMediaContent.h"
...
- (void)_generateAndSaveVideoThumnailWithCompletion:(CDUnknownBlockType)arg1;
- (void)_generateVideoThumnailWithCompletion:(CDUnknownBlockType)arg1;
