...
@class AVAsset, AVAssetReader, AVAssetReaderAudioMixOutput, AVAssetReaderTrackOutput, AVAssetWriter, AVAssetWriterInput, FBKVOController, NSArray, NSData, NSError, NSString, NSURL, SCImageProcessAssetWriterInputPixelBufferAdaptor, SCImageProcessQueue, SCImageProcessVideoExportStaticFrameConfig;
...
@interface SCImageProcessVideoExportSession : NSObject <SCImageProcessVideoExportHandlerDelegate>
{
    ...
    SCImageProcessVideoExportStaticFrameConfig *_magicMomentConfig;
