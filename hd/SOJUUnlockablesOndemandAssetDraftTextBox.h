...
#import "SOJUUnlockablesOndemandAssetDraftTextBox.h"
...
@property(readonly, copy, nonatomic) NSString *editingFontSize; // @synthesize editingFontSize=_editingFontSize;
