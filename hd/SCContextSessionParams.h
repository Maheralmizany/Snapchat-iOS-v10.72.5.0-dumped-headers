...
#import "SCSnapActionsSnapParams.h"

@class CLLocation, EphemeralMedia, FriendStories, NSString, SCCTXContextClientInfo, SCDiscoverChunk, SCLensSbSnappableMessage, SCStoriesSnapPlaybackMetadata, Snap, Story;

@interface SCContextSessionParams : NSObject <SCContextDataProviding, SCSnapActionsSnapParams>
{
    NSString *_venueId;
    _Bool _hasFilter;
    ...
    SCDiscoverChunk *_discoverChunk;
...
- (id)initWithDiscoverChunk:(id)arg1 properties:(id)arg2;
- (id)init;
