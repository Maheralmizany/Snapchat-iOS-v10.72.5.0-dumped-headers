...
@interface SCGalleryOperaSnapEntryInfo : NSObject <NSCopying>
{
    ...
    _Bool _isFailedEntry;
    int _entryType;
    int _entrySource;
    NSString *_title;
}

@property(readonly, nonatomic) _Bool isFailedEntry; // @synthesize isFailedEntry=_isFailedEntry;
...
- (id)initWithEntryType:(int)arg1 title:(id)arg2 entrySource:(int)arg3 isPrivate:(_Bool)arg4 isEntryClientCompatible:(_Bool)arg5 isPendingBackup:(_Bool)arg6 isPersistLocally:(_Bool)arg7 isTemporaryFeatured:(_Bool)arg8 isFailedEntry:(_Bool)arg9;
