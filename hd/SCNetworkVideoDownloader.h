...
@class NSString, SCCache, SCLazy, SCSessionRequestManager;

@interface SCNetworkVideoDownloader : SCLegacyItemDownloader
{
    SCSessionRequestManager *_requestManager;
    SCLazy *_contentDelivery;
    long long _mediaContextType;
    NSString *_clientRequestContext;
    unsigned long long _queuePerformerContext;
    SCCache *_mediaCache;
}
...
- (id)initWithRequestManager:(id)arg1 contentDelivery:(id)arg2 mediaContextType:(long long)arg3 clientRequestContext:(id)arg4 queuePerformerContext:(unsigned long long)arg5 mediaCache:(id)arg6;
