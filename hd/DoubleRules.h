...
@property(nonatomic) double const_p; // @dynamic const_p;
@property(nonatomic) double gt; // @dynamic gt;
@property(nonatomic) double gte; // @dynamic gte;
...
@property(retain, nonatomic) GPBDoubleArray *inArray; // @dynamic inArray;
@property(readonly, nonatomic) unsigned long long inArray_Count; // @dynamic inArray_Count;
@property(nonatomic) double lt; // @dynamic lt;
@property(nonatomic) double lte; // @dynamic lte;
@property(retain, nonatomic) GPBDoubleArray *notInArray; // @dynamic notInArray;
