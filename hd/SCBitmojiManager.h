...
#import "SCBitmojiManagerProtocol.h"
#import "SCBitmojiMetricsProvider.h"
#import "SCUserSessionScoped.h"

@class NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString, SCBehaviorSubject, SCBitmojiDownloadQueue, SCBitmojiJobCollector, SCBitmojiMetricsCollector, SCBitmojiMetricsReporter, SCBitmojiNetworkPolicy, SCDisposableObserver, SCLazy, SCObservable, SCWeakTimer;
