...
#import "SCOperaWebAppLayerViewDelegate.h"
...
- (void)webAppLayerViewWillStartLoadingRequest;
- (void)webAppLayerViewDidFinishLoadingWebViewContent;
- (void)webAppLayerViewDidFinishVideoLoadingView;
- (void)webAppLayerViewDidStartVideoLoadingView;
- (void)webAppLayerViewDidRemoveLoadingViewWithLoggingParams:(id)arg1;
